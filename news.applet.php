...
print "<TABLE BORDER=0 width=\"100%\" CELLPADDING=0 CELLSPACING=0><tr><td CLASS='plainTHead2' BGCOLOR='#E4C898'><b>Nyheter</b></td><td align=right CLASS='plainTHead2' BGCOLOR='#E4C898'><a href=news.php class=a2>Nyhetsarkiv</a></b></td></tr><tr><td colspan=2>&nbsp;</td></tr></table>";
...
foreach( $newss as $news ) {
	...
	print "<td class=plainTHead2 width=200 valign=top >".$news['newsheader']."</td><td valign=top align=right>";
	...
	print "<tr><td class=plainText colspan=2 valign=top>".rq( $news['newsingress'] )."</td></tr>";
	...
	print "</td></tr>";
	print "<tr><td colspan=2 valign=top align=right><a href=news.php?newsID=".$news['newsid']." class=a2>L&auml;s mer &nbsp;<img src=images/icons/arrows.gif width=20 height=11 border=0></a>";
