...
if (!function_exists('Dwoo_Plugin_userlink_4a776462a7dea')) {
function Dwoo_Plugin_userlink_4a776462a7dea(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4a776462a7dea'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a776462a7dea'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_actions_4a776462b882f')) {
function Dwoo_Plugin_actions_4a776462b882f(Dwoo $dwoo, $actions) {
static $_callCnt = 0;
$dwoo->scope[' 4a776462b882f'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a776462b882f'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_input_4a776462e66c9')) {
function Dwoo_Plugin_input_4a776462e66c9(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4a776462e66c9'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a776462e66c9'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_event_teaser_4a77646348558')) {
function Dwoo_Plugin_event_teaser_4a77646348558(Dwoo $dwoo, $data, $truncate = true) {
static $_callCnt = 0;
$dwoo->scope[' 4a77646348558'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a77646348558'.($_callCnt++)));
...
?> <?php echo Dwoo_Plugin_fuzzytime($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'date',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), true, 'Y-m-d H:i');
		...
		<h4 class="subtitle"><span class="event-date"><?php echo Dwoo_Plugin_nicedate($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'date',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true));?> i <?php echo $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'locationName',  ),  3 =>   array (    0 => '',    1 => '',  ),), $dwoo->scope["data"], false);?></span> | Upplagd av <?php echo Dwoo_Plugin_userlink_4a776462a7dea($dwoo, (isset($dwoo->scope["data"]) ? $dwoo->scope["data"] : null));?> för <?php echo Dwoo_Plugin_timesince($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'created',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), ' sedan', true, 'Y-m-d H:i');?></h4>
...
?>
		...
		<?php echo Dwoo_Plugin_actions_4a776462b882f($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'actions',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true));?>
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4a776462e66c9($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4a776462e66c9($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4a776462e66c9($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4a776462e66c9($this, "password", "password", "Lösen: ", '', '');?>
...
<div class="grid_8 alpha">
	<?php 
$_fh5_data = (isset($this->scope["upcoming"]) ? $this->scope["upcoming"] : null);
if ($this->isArray($_fh5_data) === true)
{
	foreach ($_fh5_data as $this->scope['event'])
	{
/* -- foreach start output */
?>
		<?php echo Dwoo_Plugin_event_teaser_4a77646348558($this, (isset($this->scope["event"]) ? $this->scope["event"] : null), true);?>
...
?>
	...
	<?php 
$_fh6_data = (isset($this->scope["attending"]) ? $this->scope["attending"] : null);
...
?>
	...
	<?php 
$_fh7_data = (isset($this->scope["posted"]) ? $this->scope["posted"] : null);
