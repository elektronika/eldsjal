...
if (!function_exists('Dwoo_Plugin_userlink_4a776814e3561')) {
function Dwoo_Plugin_userlink_4a776814e3561(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4a776814e3561'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a776814e3561'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_userimage_4a776814e73f4')) {
function Dwoo_Plugin_userimage_4a776814e73f4(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4a776814e73f4'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a776814e73f4'.($_callCnt++)));
$dwoo->scope['user'] = $user;
/* -- template start output */?>
...
if (!function_exists('Dwoo_Plugin_actions_4a776814ec1f5')) {
function Dwoo_Plugin_actions_4a776814ec1f5(Dwoo $dwoo, $actions) {
static $_callCnt = 0;
$dwoo->scope[' 4a776814ec1f5'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a776814ec1f5'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_bubble_4a776814ef0fe')) {
function Dwoo_Plugin_bubble_4a776814ef0fe(Dwoo $dwoo, $data) {
static $_callCnt = 0;
$dwoo->scope[' 4a776814ef0fe'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a776814ef0fe'.($_callCnt++)));
...
?><a name="post-<?php echo $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'id',  ),  3 =>   array (    0 => '',    1 => '',  ),), $dwoo->scope["data"], false);?>"></a><?php 
	...
	<div class="bubble-userdata">
		<?php echo Dwoo_Plugin_userimage_4a776814e73f4($dwoo, (isset($dwoo->scope["data"]) ? $dwoo->scope["data"] : null));?>

		<?php echo Dwoo_Plugin_userlink_4a776814e3561($dwoo, (isset($dwoo->scope["data"]) ? $dwoo->scope["data"] : null));?>
	...
	<?php echo Dwoo_Plugin_timesince($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'created',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), ' sedan', true, 'Y-m-d H:i');?> <?php echo Dwoo_Plugin_actions_4a776814ec1f5($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'actions',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true));?>
...
if (!function_exists('Dwoo_Plugin_input_4a776815154cd')) {
function Dwoo_Plugin_input_4a776815154cd(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4a776815154cd'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a776815154cd'.($_callCnt++)));
...
'';// checking for modification in file:/var/www/eldsjal.org/system/application/views/people.tpl
if (!("1249327860" == filemtime('/var/www/eldsjal.org/system/application/views/people.tpl'))) { ob_end_clean(); return false; };
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4a776815154cd($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4a776815154cd($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4a776815154cd($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4a776815154cd($this, "password", "password", "Lösen: ", '', '');?>
...
<?php 
$_fh5_data = (isset($this->scope["people"]) ? $this->scope["people"] : null);
if ($this->isArray($_fh5_data) === true)
{
	foreach ($_fh5_data as $this->scope['dude'])
	{
/* -- foreach start output */
?>
	<?php echo Dwoo_Plugin_bubble_4a776814ef0fe($this, (isset($this->scope["dude"]) ? $this->scope["dude"] : null));?>
