...
if (!function_exists('Dwoo_Plugin_input_4a78d5df873a9')) {
function Dwoo_Plugin_input_4a78d5df873a9(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4a78d5df873a9'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a78d5df873a9'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_textarea_4a78d5dfa06a4')) {
function Dwoo_Plugin_textarea_4a78d5dfa06a4(Dwoo $dwoo, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4a78d5dfa06a4'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a78d5dfa06a4'.($_callCnt++)));
$dwoo->scope['name'] = $name;
$dwoo->scope['label'] = $label;
$dwoo->scope['value'] = $value;
$dwoo->scope['error'] = $error;
...
if (!function_exists('Dwoo_Plugin_select_4a78d5dfaf13a')) {
function Dwoo_Plugin_select_4a78d5dfaf13a(Dwoo $dwoo, $name, $options, $default = "", $label = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4a78d5dfaf13a'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a78d5dfaf13a'.($_callCnt++)));
$dwoo->scope['name'] = $name;
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4a78d5df873a9($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4a78d5df873a9($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4a78d5df873a9($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4a78d5df873a9($this, "password", "password", "Lösen: ", '', '');?>
...
<?php echo Dwoo_Plugin_input_4a78d5df873a9($this, "text", "title", "Rubrik", '', '');?>

<?php echo Dwoo_Plugin_select_4a78d5dfaf13a($this, "category", (isset($this->scope["categories"]) ? $this->scope["categories"] : null), (isset($this->scope["cat_id"]) ? $this->scope["cat_id"] : null), "Kategori", '');?>

<?php echo Dwoo_Plugin_textarea_4a78d5dfa06a4($this, "body", "Inlägg", '', '');?>

<?php echo Dwoo_Plugin_input_4a78d5df873a9($this, "submit", "submit", "", "Spara", '');?>
