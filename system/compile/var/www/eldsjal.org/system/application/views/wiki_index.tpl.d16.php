...
if (!function_exists('Dwoo_Plugin_input_4a777151e78f8')) {
function Dwoo_Plugin_input_4a777151e78f8(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4a777151e78f8'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a777151e78f8'.($_callCnt++)));
...
'';// checking for modification in file:/var/www/eldsjal.org/system/application/views/wiki.tpl
if (!("1249327895" == filemtime('/var/www/eldsjal.org/system/application/views/wiki.tpl'))) { ob_end_clean(); return false; };
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4a777151e78f8($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4a777151e78f8($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4a777151e78f8($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4a777151e78f8($this, "password", "password", "Lösen: ", '', '');?>
