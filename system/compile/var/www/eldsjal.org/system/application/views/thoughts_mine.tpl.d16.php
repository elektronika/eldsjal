...
if (!function_exists('Dwoo_Plugin_userlink_4a7ea99be36ad')) {
function Dwoo_Plugin_userlink_4a7ea99be36ad(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4a7ea99be36ad'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a7ea99be36ad'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_actions_4a7ea99bee2ac')) {
function Dwoo_Plugin_actions_4a7ea99bee2ac(Dwoo $dwoo, $actions) {
static $_callCnt = 0;
$dwoo->scope[' 4a7ea99bee2ac'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a7ea99bee2ac'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_teaser_4a7ea99c07b2d')) {
function Dwoo_Plugin_teaser_4a7ea99c07b2d(Dwoo $dwoo, $data, $truncate = true) {
static $_callCnt = 0;
$dwoo->scope[' 4a7ea99c07b2d'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a7ea99c07b2d'.($_callCnt++)));
...
?> av <?php echo Dwoo_Plugin_userlink_4a7ea99be36ad($dwoo, (isset($dwoo->scope["data"]) ? $dwoo->scope["data"] : null));

}?>

				<?php if ($dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'creator',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true)) {
?> av <?php echo Dwoo_Plugin_userlink_4a7ea99be36ad($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'creator',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true));
...
?>
		...
		<?php echo Dwoo_Plugin_actions_4a7ea99bee2ac($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'actions',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true));?>
...
if (!function_exists('Dwoo_Plugin_input_4a7ea99c2212b')) {
function Dwoo_Plugin_input_4a7ea99c2212b(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4a7ea99c2212b'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a7ea99c2212b'.($_callCnt++)));
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4a7ea99c2212b($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4a7ea99c2212b($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4a7ea99c2212b($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4a7ea99c2212b($this, "password", "password", "Lösen: ", '', '');?>
...
/* -- foreach start output */
?>
	<?php echo Dwoo_Plugin_teaser_4a7ea99c07b2d($this, (isset($this->scope["thought"]) ? $this->scope["thought"] : null), true);?>
