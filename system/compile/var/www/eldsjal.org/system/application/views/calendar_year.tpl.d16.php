...
if (!function_exists('Dwoo_Plugin_input_4a78cfc4ca4a2')) {
function Dwoo_Plugin_input_4a78cfc4ca4a2(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4a78cfc4ca4a2'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a78cfc4ca4a2'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_datepager_4a78cfc5092f8')) {
function Dwoo_Plugin_datepager_4a78cfc5092f8(Dwoo $dwoo, $prefix, $year, $month = null, $day = null) {
static $_callCnt = 0;
$dwoo->scope[' 4a78cfc5092f8'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a78cfc5092f8'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_calendar_4a78cfc51bb76')) {
function Dwoo_Plugin_calendar_4a78cfc51bb76(Dwoo $dwoo, $events, $month, $year) {
static $_callCnt = 0;
$dwoo->scope[' 4a78cfc51bb76'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a78cfc51bb76'.($_callCnt++)));
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4a78cfc4ca4a2($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4a78cfc4ca4a2($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4a78cfc4ca4a2($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4a78cfc4ca4a2($this, "password", "password", "Lösen: ", '', '');?>
...
<?php echo Dwoo_Plugin_datepager_4a78cfc5092f8($this, '/calendar/browse/', (isset($this->scope["year"]) ? $this->scope["year"] : null), null, null);?>
...
?>
	...
	<?php echo Dwoo_Plugin_calendar_4a78cfc51bb76($this, $this->readVar("events.".(isset($this->scope["month_number"]) ? $this->scope["month_number"] : null)), (isset($this->scope["month_number"]) ? $this->scope["month_number"] : null), (isset($this->scope["year"]) ? $this->scope["year"] : null));?>
