...
if (!function_exists('Dwoo_Plugin_userlink_4a78d38477778')) {
function Dwoo_Plugin_userlink_4a78d38477778(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4a78d38477778'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a78d38477778'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_pager_4a78d3848236b')) {
function Dwoo_Plugin_pager_4a78d3848236b(Dwoo $dwoo, $pager) {
static $_callCnt = 0;
$dwoo->scope[' 4a78d3848236b'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a78d3848236b'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_actions_4a78d384861f6')) {
function Dwoo_Plugin_actions_4a78d384861f6(Dwoo $dwoo, $actions) {
static $_callCnt = 0;
$dwoo->scope[' 4a78d384861f6'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a78d384861f6'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_teaser_4a78d38497b4a')) {
function Dwoo_Plugin_teaser_4a78d38497b4a(Dwoo $dwoo, $data, $truncate = true) {
static $_callCnt = 0;
$dwoo->scope[' 4a78d38497b4a'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a78d38497b4a'.($_callCnt++)));
...
?> av <?php echo Dwoo_Plugin_userlink_4a78d38477778($dwoo, (isset($dwoo->scope["data"]) ? $dwoo->scope["data"] : null));

}?>

				<?php if ($dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'creator',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true)) {
?> av <?php echo Dwoo_Plugin_userlink_4a78d38477778($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'creator',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true));
...
?>
		...
		<?php echo Dwoo_Plugin_actions_4a78d384861f6($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'actions',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true));?>
...
if (!function_exists('Dwoo_Plugin_input_4a78d384b7089')) {
function Dwoo_Plugin_input_4a78d384b7089(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4a78d384b7089'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a78d384b7089'.($_callCnt++)));
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4a78d384b7089($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4a78d384b7089($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4a78d384b7089($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4a78d384b7089($this, "password", "password", "Lösen: ", '', '');?>
...
/* -- foreach start output */
?>
	<?php echo Dwoo_Plugin_teaser_4a78d38497b4a($this, (isset($this->scope["thought"]) ? $this->scope["thought"] : null), true);?>
...
<?php echo Dwoo_Plugin_pager_4a78d3848236b($this, (isset($this->scope["pager"]) ? $this->scope["pager"] : null));?>
