...
if (!function_exists('Dwoo_Plugin_input_4a7b180cad57e')) {
function Dwoo_Plugin_input_4a7b180cad57e(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4a7b180cad57e'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a7b180cad57e'.($_callCnt++)));
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4a7b180cad57e($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4a7b180cad57e($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4a7b180cad57e($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4a7b180cad57e($this, "password", "password", "Lösen: ", '', '');?>
