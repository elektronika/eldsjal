...
if (function_exists('Dwoo_Plugin_timesince')===false)
	$this->getLoader()->loadPlugin('timesince');
...
if (!function_exists('Dwoo_Plugin_userlink_4a77672840c12')) {
function Dwoo_Plugin_userlink_4a77672840c12(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4a77672840c12'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a77672840c12'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_userimage_4a77672845a3b')) {
function Dwoo_Plugin_userimage_4a77672845a3b(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4a77672845a3b'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a77672845a3b'.($_callCnt++)));
$dwoo->scope['user'] = $user;
/* -- template start output */?>
...
if (!function_exists('Dwoo_Plugin_actions_4a7767284b7fb')) {
function Dwoo_Plugin_actions_4a7767284b7fb(Dwoo $dwoo, $actions) {
static $_callCnt = 0;
$dwoo->scope[' 4a7767284b7fb'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a7767284b7fb'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_bubble_4a77672850625')) {
function Dwoo_Plugin_bubble_4a77672850625(Dwoo $dwoo, $data) {
static $_callCnt = 0;
$dwoo->scope[' 4a77672850625'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a77672850625'.($_callCnt++)));
...
?><a name="post-<?php echo $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'id',  ),  3 =>   array (    0 => '',    1 => '',  ),), $dwoo->scope["data"], false);?>"></a><?php 
	...
	<div class="bubble-userdata">
		<?php echo Dwoo_Plugin_userimage_4a77672845a3b($dwoo, (isset($dwoo->scope["data"]) ? $dwoo->scope["data"] : null));?>

		<?php echo Dwoo_Plugin_userlink_4a77672840c12($dwoo, (isset($dwoo->scope["data"]) ? $dwoo->scope["data"] : null));?>
	...
	<?php echo Dwoo_Plugin_timesince($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'created',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), ' sedan', true, 'Y-m-d H:i');?> <?php echo Dwoo_Plugin_actions_4a7767284b7fb($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'actions',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true));?>
...
if (!function_exists('Dwoo_Plugin_input_4a7767287581d')) {
function Dwoo_Plugin_input_4a7767287581d(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4a7767287581d'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a7767287581d'.($_callCnt++)));
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4a7767287581d($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4a7767287581d($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4a7767287581d($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4a7767287581d($this, "password", "password", "Lösen: ", '', '');?>
...
<h2 class="title"><?php echo $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'title',  ),  3 =>   array (    0 => '',    1 => '',  ),), $this->scope["thought"], false);?> <span><?php echo Dwoo_Plugin_timesince($this, $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'created',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["thought"]) ? $this->scope["thought"]:null), true), ' sedan', true, 'Y-m-d H:i');?></span></h2>
<?php echo Dwoo_Plugin_bubble_4a77672850625($this, (isset($this->scope["thought"]) ? $this->scope["thought"] : null));?>
