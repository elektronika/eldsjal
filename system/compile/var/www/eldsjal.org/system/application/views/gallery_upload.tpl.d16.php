...
if (!function_exists('Dwoo_Plugin_input_4a77645b820ce')) {
function Dwoo_Plugin_input_4a77645b820ce(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4a77645b820ce'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a77645b820ce'.($_callCnt++)));
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4a77645b820ce($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4a77645b820ce($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4a77645b820ce($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4a77645b820ce($this, "password", "password", "Lösen: ", '', '');?>
...
<?php echo Dwoo_Plugin_input_4a77645b820ce($this, "file", "file", "Börja med att välja filen som ska laddas upp...", '', '');?>

<?php echo Dwoo_Plugin_input_4a77645b820ce($this, "text", "title", "...ge den en schysst titel...", '', '');?>

<?php echo Dwoo_Plugin_input_4a77645b820ce($this, "text", "body", "...och en lattjo beskrivning", '', '');?>

<?php 
$_fh5_data = (isset($this->scope["tags"]) ? $this->scope["tags"] : null);
...
echo Dwoo_Plugin_input_4a77645b820ce($this, "checkbox", "tag[".$this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'id',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["tag"]) ? $this->scope["tag"]:null), true)."]", $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'tag',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["tag"]) ? $this->scope["tag"]:null), true), '', '');

/* -- foreach end output */
	}
}?>

<?php echo Dwoo_Plugin_input_4a77645b820ce($this, "submit", "submit", "", "Spara", '');?>
