...
if (!function_exists('Dwoo_Plugin_input_4a7761e5f029b')) {
function Dwoo_Plugin_input_4a7761e5f029b(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4a7761e5f029b'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a7761e5f029b'.($_callCnt++)));
...
<head>
	<title>Eldsjäl - Hippies, Herpes &amp; Hampa</title>
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4a7761e5f029b($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4a7761e5f029b($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4a7761e5f029b($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4a7761e5f029b($this, "password", "password", "Lösen: ", '', '');?>
