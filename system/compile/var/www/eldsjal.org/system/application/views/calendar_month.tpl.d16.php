...
if (!function_exists('Dwoo_Plugin_input_4a786f7e0d6d6')) {
function Dwoo_Plugin_input_4a786f7e0d6d6(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4a786f7e0d6d6'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a786f7e0d6d6'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_datepager_4a786f7e37750')) {
function Dwoo_Plugin_datepager_4a786f7e37750(Dwoo $dwoo, $prefix, $year, $month = null, $day = null) {
static $_callCnt = 0;
$dwoo->scope[' 4a786f7e37750'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a786f7e37750'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_calendar_4a786f7e53bf3')) {
function Dwoo_Plugin_calendar_4a786f7e53bf3(Dwoo $dwoo, $events, $month, $year) {
static $_callCnt = 0;
$dwoo->scope[' 4a786f7e53bf3'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a786f7e53bf3'.($_callCnt++)));
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4a786f7e0d6d6($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4a786f7e0d6d6($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4a786f7e0d6d6($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4a786f7e0d6d6($this, "password", "password", "Lösen: ", '', '');?>
...
<?php echo Dwoo_Plugin_datepager_4a786f7e37750($this, '/calendar/browse/', (isset($this->scope["year"]) ? $this->scope["year"] : null), (isset($this->scope["month"]) ? $this->scope["month"] : null), null);?>

<div class="calendar-month">
<?php echo Dwoo_Plugin_calendar_4a786f7e53bf3($this, (isset($this->scope["events"]) ? $this->scope["events"] : null), (isset($this->scope["month"]) ? $this->scope["month"] : null), (isset($this->scope["year"]) ? $this->scope["year"] : null));?>
