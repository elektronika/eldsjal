...
if (!function_exists('Dwoo_Plugin_userlink_4a7f3e39a63c4')) {
function Dwoo_Plugin_userlink_4a7f3e39a63c4(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4a7f3e39a63c4'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a7f3e39a63c4'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_actions_4a7f3e39b5de6')) {
function Dwoo_Plugin_actions_4a7f3e39b5de6(Dwoo $dwoo, $actions) {
static $_callCnt = 0;
$dwoo->scope[' 4a7f3e39b5de6'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a7f3e39b5de6'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_input_4a7f3e39e8aa8')) {
function Dwoo_Plugin_input_4a7f3e39e8aa8(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4a7f3e39e8aa8'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a7f3e39e8aa8'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_event_teaser_4a7f3e3a4da66')) {
function Dwoo_Plugin_event_teaser_4a7f3e3a4da66(Dwoo $dwoo, $data, $truncate = true) {
static $_callCnt = 0;
$dwoo->scope[' 4a7f3e3a4da66'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a7f3e3a4da66'.($_callCnt++)));
...
?> <?php echo Dwoo_Plugin_fuzzytime($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'date',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), true, 'Y-m-d H:i');
		...
		<h4 class="subtitle"><span class="event-date"><?php echo Dwoo_Plugin_nicedate($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'date',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true));?> i <?php echo $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'locationName',  ),  3 =>   array (    0 => '',    1 => '',  ),), $dwoo->scope["data"], false);?></span> | Upplagd av <?php echo Dwoo_Plugin_userlink_4a7f3e39a63c4($dwoo, (isset($dwoo->scope["data"]) ? $dwoo->scope["data"] : null));?> för <?php echo Dwoo_Plugin_timesince($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'created',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), ' sedan', true, 'Y-m-d H:i');?></h4>
...
?>
		...
		<?php echo Dwoo_Plugin_actions_4a7f3e39b5de6($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'actions',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true));?>
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4a7f3e39e8aa8($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4a7f3e39e8aa8($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4a7f3e39e8aa8($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4a7f3e39e8aa8($this, "password", "password", "Lösen: ", '', '');?>
...
/* -- foreach start output */
?>
		<?php echo Dwoo_Plugin_event_teaser_4a7f3e3a4da66($this, (isset($this->scope["event"]) ? $this->scope["event"] : null), true);?>
