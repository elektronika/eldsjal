...
if (!function_exists('Dwoo_Plugin_userlink_4a77647039dbd')) {
function Dwoo_Plugin_userlink_4a77647039dbd(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4a77647039dbd'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a77647039dbd'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_pager_4a776470449ad')) {
function Dwoo_Plugin_pager_4a776470449ad(Dwoo $dwoo, $pager) {
static $_callCnt = 0;
$dwoo->scope[' 4a776470449ad'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a776470449ad'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_actions_4a7764704788e')) {
function Dwoo_Plugin_actions_4a7764704788e(Dwoo $dwoo, $actions) {
static $_callCnt = 0;
$dwoo->scope[' 4a7764704788e'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a7764704788e'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_teaser_4a776470591c9')) {
function Dwoo_Plugin_teaser_4a776470591c9(Dwoo $dwoo, $data, $truncate = true) {
static $_callCnt = 0;
$dwoo->scope[' 4a776470591c9'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a776470591c9'.($_callCnt++)));
...
?> av <?php echo Dwoo_Plugin_userlink_4a77647039dbd($dwoo, (isset($dwoo->scope["data"]) ? $dwoo->scope["data"] : null));

}?>

				<?php if ($dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'creator',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true)) {
?> av <?php echo Dwoo_Plugin_userlink_4a77647039dbd($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'creator',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true));
...
?>
		...
		<?php echo Dwoo_Plugin_actions_4a7764704788e($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'actions',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true));?>
...
if (!function_exists('Dwoo_Plugin_input_4a7764707a5bd')) {
function Dwoo_Plugin_input_4a7764707a5bd(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4a7764707a5bd'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a7764707a5bd'.($_callCnt++)));
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4a7764707a5bd($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4a7764707a5bd($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4a7764707a5bd($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4a7764707a5bd($this, "password", "password", "Lösen: ", '', '');?>
...
<?php 
$_fh5_data = (isset($this->scope["topics"]) ? $this->scope["topics"] : null);
if ($this->isArray($_fh5_data) === true)
{
	foreach ($_fh5_data as $this->scope['topic'])
	{
/* -- foreach start output */
?>
	<?php echo Dwoo_Plugin_teaser_4a776470591c9($this, (isset($this->scope["topic"]) ? $this->scope["topic"] : null), false);?>
...
<?php echo Dwoo_Plugin_pager_4a776470449ad($this, (isset($this->scope["pager"]) ? $this->scope["pager"] : null));?>
