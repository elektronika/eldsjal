...
if (!function_exists('Dwoo_Plugin_input_4a77673e75b06')) {
function Dwoo_Plugin_input_4a77673e75b06(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4a77673e75b06'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a77673e75b06'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_textarea_4a77673e8551e')) {
function Dwoo_Plugin_textarea_4a77673e8551e(Dwoo $dwoo, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4a77673e8551e'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a77673e8551e'.($_callCnt++)));
$dwoo->scope['name'] = $name;
$dwoo->scope['label'] = $label;
$dwoo->scope['value'] = $value;
$dwoo->scope['error'] = $error;
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4a77673e75b06($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4a77673e75b06($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4a77673e75b06($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4a77673e75b06($this, "password", "password", "Lösen: ", '', '');?>
...
<?php echo Dwoo_Plugin_input_4a77673e75b06($this, "text", "title", "Rubrik", $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'title',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["thought"]) ? $this->scope["thought"]:null), true), '');?>

<?php echo Dwoo_Plugin_textarea_4a77673e8551e($this, "body", "Din tanke", $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'body',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["thought"]) ? $this->scope["thought"]:null), true), '');?>

<?php echo Dwoo_Plugin_input_4a77673e75b06($this, "submit", "submit", "", "Spara", '');?>
