...
if (!function_exists('Dwoo_Plugin_input_4a7b180339339')) {
function Dwoo_Plugin_input_4a7b180339339(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4a7b180339339'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a7b180339339'.($_callCnt++)));
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4a7b180339339($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4a7b180339339($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4a7b180339339($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4a7b180339339($this, "password", "password", "Lösen: ", '', '');?>
