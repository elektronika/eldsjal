...
if (!function_exists('Dwoo_Plugin_userlink_4a7b09139493f')) {
function Dwoo_Plugin_userlink_4a7b09139493f(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4a7b09139493f'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a7b09139493f'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_actions_4a7b09139e5dc')) {
function Dwoo_Plugin_actions_4a7b09139e5dc(Dwoo $dwoo, $actions) {
static $_callCnt = 0;
$dwoo->scope[' 4a7b09139e5dc'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a7b09139e5dc'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_teaser_4a7b0913ad051')) {
function Dwoo_Plugin_teaser_4a7b0913ad051(Dwoo $dwoo, $data, $truncate = true) {
static $_callCnt = 0;
$dwoo->scope[' 4a7b0913ad051'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a7b0913ad051'.($_callCnt++)));
...
?> av <?php echo Dwoo_Plugin_userlink_4a7b09139493f($dwoo, (isset($dwoo->scope["data"]) ? $dwoo->scope["data"] : null));

}?>

				<?php if ($dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'creator',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true)) {
?> av <?php echo Dwoo_Plugin_userlink_4a7b09139493f($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'creator',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true));
...
?>
		...
		<?php echo Dwoo_Plugin_actions_4a7b09139e5dc($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'actions',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true));?>
...
if (!function_exists('Dwoo_Plugin_input_4a7b0913d1263')) {
function Dwoo_Plugin_input_4a7b0913d1263(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4a7b0913d1263'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a7b0913d1263'.($_callCnt++)));
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4a7b0913d1263($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4a7b0913d1263($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4a7b0913d1263($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4a7b0913d1263($this, "password", "password", "Lösen: ", '', '');?>
...
<h2>Forum</h2>
<?php 
$_fh5_data = (isset($this->scope["categories"]) ? $this->scope["categories"] : null);
if ($this->isArray($_fh5_data) === true)
{
	foreach ($_fh5_data as $this->scope['cat'])
	{
/* -- foreach start output */
?>
<?php echo Dwoo_Plugin_teaser_4a7b0913ad051($this, (isset($this->scope["cat"]) ? $this->scope["cat"] : null), false);?>
