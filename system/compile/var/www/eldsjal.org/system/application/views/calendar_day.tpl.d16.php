...
if (!function_exists('Dwoo_Plugin_userlink_4a786f94f41e2')) {
function Dwoo_Plugin_userlink_4a786f94f41e2(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4a786f94f41e2'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a786f94f41e2'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_actions_4a786f9509bf1')) {
function Dwoo_Plugin_actions_4a786f9509bf1(Dwoo $dwoo, $actions) {
static $_callCnt = 0;
$dwoo->scope[' 4a786f9509bf1'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a786f9509bf1'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_input_4a786f95399cf')) {
function Dwoo_Plugin_input_4a786f95399cf(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4a786f95399cf'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a786f95399cf'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_datepager_4a786f95668db')) {
function Dwoo_Plugin_datepager_4a786f95668db(Dwoo $dwoo, $prefix, $year, $month = null, $day = null) {
static $_callCnt = 0;
$dwoo->scope[' 4a786f95668db'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a786f95668db'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_event_teaser_4a786f9587c53')) {
function Dwoo_Plugin_event_teaser_4a786f9587c53(Dwoo $dwoo, $data, $truncate = true) {
static $_callCnt = 0;
$dwoo->scope[' 4a786f9587c53'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a786f9587c53'.($_callCnt++)));
...
?> <?php echo Dwoo_Plugin_fuzzytime($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'date',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), true, 'Y-m-d H:i');
		...
		<h4 class="subtitle"><span class="event-date"><?php echo Dwoo_Plugin_nicedate($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'date',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true));?> i <?php echo $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'locationName',  ),  3 =>   array (    0 => '',    1 => '',  ),), $dwoo->scope["data"], false);?></span> | Upplagd av <?php echo Dwoo_Plugin_userlink_4a786f94f41e2($dwoo, (isset($dwoo->scope["data"]) ? $dwoo->scope["data"] : null));?> för <?php echo Dwoo_Plugin_timesince($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'created',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), ' sedan', true, 'Y-m-d H:i');?></h4>
...
?>
		...
		<?php echo Dwoo_Plugin_actions_4a786f9509bf1($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'actions',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true));?>
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4a786f95399cf($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4a786f95399cf($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4a786f95399cf($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4a786f95399cf($this, "password", "password", "Lösen: ", '', '');?>
...
<?php echo Dwoo_Plugin_datepager_4a786f95668db($this, '/calendar/browse/', (isset($this->scope["year"]) ? $this->scope["year"] : null), (isset($this->scope["month"]) ? $this->scope["month"] : null), (isset($this->scope["day"]) ? $this->scope["day"] : null));?>

<?php 
$_fh5_data = (isset($this->scope["events"]) ? $this->scope["events"] : null);
...
/* -- foreach start output */
?>
	<?php echo Dwoo_Plugin_event_teaser_4a786f9587c53($this, (isset($this->scope["event"]) ? $this->scope["event"] : null), true);?>
