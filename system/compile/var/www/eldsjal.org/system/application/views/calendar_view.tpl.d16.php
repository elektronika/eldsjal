...
if (!function_exists('Dwoo_Plugin_userlink_4a776bea8ad85')) {
function Dwoo_Plugin_userlink_4a776bea8ad85(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4a776bea8ad85'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a776bea8ad85'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_actions_4a776bea92aab')) {
function Dwoo_Plugin_actions_4a776bea92aab(Dwoo $dwoo, $actions) {
static $_callCnt = 0;
$dwoo->scope[' 4a776bea92aab'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a776bea92aab'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_input_4a776beabab84')) {
function Dwoo_Plugin_input_4a776beabab84(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4a776beabab84'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a776beabab84'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_event_teaser_4a776beb1e82e')) {
function Dwoo_Plugin_event_teaser_4a776beb1e82e(Dwoo $dwoo, $data, $truncate = true) {
static $_callCnt = 0;
$dwoo->scope[' 4a776beb1e82e'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a776beb1e82e'.($_callCnt++)));
...
?> <?php echo Dwoo_Plugin_fuzzytime($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'date',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), true, 'Y-m-d H:i');
		...
		<h4 class="subtitle"><span class="event-date"><?php echo Dwoo_Plugin_nicedate($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'date',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true));?> i <?php echo $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'locationName',  ),  3 =>   array (    0 => '',    1 => '',  ),), $dwoo->scope["data"], false);?></span> | Upplagd av <?php echo Dwoo_Plugin_userlink_4a776bea8ad85($dwoo, (isset($dwoo->scope["data"]) ? $dwoo->scope["data"] : null));?> för <?php echo Dwoo_Plugin_timesince($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'created',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), ' sedan', true, 'Y-m-d H:i');?></h4>
...
?>
		...
		<?php echo Dwoo_Plugin_actions_4a776bea92aab($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'actions',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true));?>
...
if (!function_exists('Dwoo_Plugin_signup_4a776beb2e232')) {
function Dwoo_Plugin_signup_4a776beb2e232(Dwoo $dwoo, $eventid) {
static $_callCnt = 0;
$dwoo->scope[' 4a776beb2e232'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a776beb2e232'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_signoff_4a776beb3016b')) {
function Dwoo_Plugin_signoff_4a776beb3016b(Dwoo $dwoo, $eventid) {
static $_callCnt = 0;
$dwoo->scope[' 4a776beb3016b'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a776beb3016b'.($_callCnt++)));
$dwoo->scope['eventid'] = $eventid;
/* -- template start output */?>
...
'';// checking for modification in file:/var/www/eldsjal.org/system/application/views/calendar.tpl
if (!("1249327804" == filemtime('/var/www/eldsjal.org/system/application/views/calendar.tpl'))) { ob_end_clean(); return false; };
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4a776beabab84($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4a776beabab84($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4a776beabab84($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4a776beabab84($this, "password", "password", "Lösen: ", '', '');?>
...
<?php echo Dwoo_Plugin_event_teaser_4a776beb1e82e($this, (isset($this->scope["event"]) ? $this->scope["event"] : null), false);?>

</div>
<div class="grid_4 omega">
	<?php if ((isset($this->scope["user_has_signed_up"]) ? $this->scope["user_has_signed_up"] : null)) {
?>
		<?php echo Dwoo_Plugin_signoff_4a776beb3016b($this, $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'id',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["event"]) ? $this->scope["event"]:null), true));?>

	<?php 
}
else {
?>
		<?php echo Dwoo_Plugin_signup_4a776beb2e232($this, $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'id',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["event"]) ? $this->scope["event"]:null), true));?>
	...
	<ul>
		<?php 
$_fh5_data = (isset($this->scope["attendees"]) ? $this->scope["attendees"] : null);
...
/* -- foreach start output */
?>
			<li><?php echo Dwoo_Plugin_userlink_4a776bea8ad85($this, (isset($this->scope["user"]) ? $this->scope["user"] : null));?></li>
		<?php 
/* -- foreach end output */
	}
}?>
