...
if (!function_exists('Dwoo_Plugin_input_4ad9e6a70a9bb')) {
function Dwoo_Plugin_input_4ad9e6a70a9bb(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e6a70a9bb'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e6a70a9bb'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_messages_4ad9e6a73b314')) {
function Dwoo_Plugin_messages_4ad9e6a73b314(Dwoo $dwoo, $messages) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e6a73b314'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e6a73b314'.($_callCnt++)));
...
'';// checking for modification in file:/var/www/eldsjal/system/application/views/wiki.tpl
if (!("1250276016" == filemtime('/var/www/eldsjal/system/application/views/wiki.tpl'))) { ob_end_clean(); return false; };
...
<head>
	<title>Eldsjäl<?php echo $this->assignInScope('wiki', 'active_section');?></title>
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4ad9e6a70a9bb($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4ad9e6a70a9bb($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4ad9e6a70a9bb($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad9e6a70a9bb($this, "password", "password", "Lösen: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad9e6a70a9bb($this, "submit", "login", "", "Ja!", '');?>
		...
		<div class="grid_8" id="submenu">
			<a class="first" href="/wiki/fadderboken">Fadderboken</a>
	<a href="/wiki/all">Alla wiki-sidor</a>
		</div>
...
<div id="content-wrap">
	<?php echo Dwoo_Plugin_messages_4ad9e6a73b314($this, Dwoo_Plugin_getMessages($this));?>
