...
if (!function_exists('Dwoo_Plugin_userlink_4a898fb6c6d43')) {
function Dwoo_Plugin_userlink_4a898fb6c6d43(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4a898fb6c6d43'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a898fb6c6d43'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_actions_4a898fb6caf8e')) {
function Dwoo_Plugin_actions_4a898fb6caf8e(Dwoo $dwoo, $actions) {
static $_callCnt = 0;
$dwoo->scope[' 4a898fb6caf8e'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a898fb6caf8e'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_teaser_4a898fb6d249f')) {
function Dwoo_Plugin_teaser_4a898fb6d249f(Dwoo $dwoo, $data, $truncate = true) {
static $_callCnt = 0;
$dwoo->scope[' 4a898fb6d249f'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a898fb6d249f'.($_callCnt++)));
...
?> skapades <?php echo Dwoo_Plugin_fuzzytime($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'created',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), true, 'Y-m-d H:i');?> <?php if ($dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'creator',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true)) {
?> av <?php echo Dwoo_Plugin_userlink_4a898fb6c6d43($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'creator',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true));
...
?> uppdaterades <?php echo Dwoo_Plugin_fuzzytime($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'updated',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), true, 'Y-m-d H:i');?> <?php if ($dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'updater',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true)) {
?> av <?php echo Dwoo_Plugin_userlink_4a898fb6c6d43($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'updater',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true));
...
?> av <?php echo Dwoo_Plugin_userlink_4a898fb6c6d43($dwoo, (isset($dwoo->scope["data"]) ? $dwoo->scope["data"] : null));
...
?>
		...
		<?php echo Dwoo_Plugin_actions_4a898fb6caf8e($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'actions',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true));?>
...
if (!function_exists('Dwoo_Plugin_input_4a898fb6e22b7')) {
function Dwoo_Plugin_input_4a898fb6e22b7(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4a898fb6e22b7'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a898fb6e22b7'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_messages_4a898fb710b24')) {
function Dwoo_Plugin_messages_4a898fb710b24(Dwoo $dwoo, $messages) {
static $_callCnt = 0;
$dwoo->scope[' 4a898fb710b24'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a898fb710b24'.($_callCnt++)));
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4a898fb6e22b7($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4a898fb6e22b7($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4a898fb6e22b7($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4a898fb6e22b7($this, "password", "password", "Lösen: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4a898fb6e22b7($this, "submit", "login", "", "Ja!", '');?>
...
<div id="content-wrap">
	<?php echo Dwoo_Plugin_messages_4a898fb710b24($this, Dwoo_Plugin_getMessages($this));?>
...
/* -- foreach start output */
?>
	<?php echo Dwoo_Plugin_teaser_4a898fb6d249f($this, (isset($this->scope["thought"]) ? $this->scope["thought"] : null), true);?>
