...
if (!function_exists('Dwoo_Plugin_input_4ad720bfa6781')) {
function Dwoo_Plugin_input_4ad720bfa6781(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4ad720bfa6781'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad720bfa6781'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_messages_4ad720bfd7c42')) {
function Dwoo_Plugin_messages_4ad720bfd7c42(Dwoo $dwoo, $messages) {
static $_callCnt = 0;
$dwoo->scope[' 4ad720bfd7c42'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad720bfd7c42'.($_callCnt++)));
$dwoo->scope['messages'] = $messages;
/* -- template start output */?>
<div class="container_16" id="messages">
	<?php 
$_fh6_data = (isset($dwoo->scope["messages"]) ? $dwoo->scope["messages"] : null);
if ($dwoo->isArray($_fh6_data) === true)
{
	foreach ($_fh6_data as $dwoo->scope['type']=>$dwoo->scope['message'])
	{
...
if (!("1255610823" == filemtime('/var/www/eldsjal/system/application/views/templates.tpl'))) { ob_end_clean(); return false; };?>
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4ad720bfa6781($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4ad720bfa6781($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4ad720bfa6781($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad720bfa6781($this, "password", "password", "Lösen: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad720bfa6781($this, "submit", "login", "", "Ja!", '');?>
...
<div id="content-wrap">
	<?php echo Dwoo_Plugin_messages_4ad720bfd7c42($this, Dwoo_Plugin_getMessages($this));?>

<div id="content" class="container_12">
	<div class="grid_16">
<div class="grid_4 alpha">
<h3>Event</h3>
<p>Eldsjäl event sysslar med arrangemang av eldsjäls större nationella träffar. De arrangerar bla. Ett av årets höjdpunkter, Camp Burn Yourself, som arrangeras varje sommar. Här finns dessutom kompetens och stöd till andra medlemmar som vill arrangera evenemang.</p>

<p><a href="http://cby.se">www.cby.se</a></p>

<p>Ansvarig: t</p>
</div>

<div class="grid_4 omega">
<h3>Internationella</h3>
<p>Alternativkonst är ett globalt fenomen, det finns mängder av organisationer som liknar Eldsjäl, i sverige och resten av världen. Vi vill såklart lära oss av dem, berätta hur vi har gått tillväga, åka och hälsa på och bjuda hit dem till oss. Internationella är alltid på jakt efter nya projekt, så har du några förslag eller idéer, hör av dig!</p>
...
<div class="grid_4 omega">
<h3>FuEl</h3>
<p>Fundrasing Eldsjäl sysslar med finansiering av eldsjäl. I skrivande stund finansieras eldsjäl till största delen av Ungdomsstyrelsen, men eldsjäl är alltid intresserad av nya spännande förslag och projekt, så hör av dig om du har några tankar, idéer eller vill hjälpa till!</p>
...
<div class="grid_4 alpha">
<h3>Core</h3>
<p>I eldsjäl är det otroligt viktgt med den personilga anknytningen. Alla nya medlemmar får en fadder som berättar hur eldsjäl funkar, presenterar den nya medlemmen för nya människor, svarar på frågor osv.</p>

<p>Att vara fadder är ett stort ansvar, hur en person upplever eldsjäl kan till stor del vara beroende av faddern. Därför håller eldsjäl nu på att utveckla och driva ett system för att lära och motivera faddrarna. Detta sysslar core med</p>

<p>Ansvarig: kristoffer</p>
</div>

<div class="grid_4">
<h3>Elektronika</h3>
<p>Det är vi som bygger, trixar, meckar och ser till att eldsjäls hemsida fungerar och utvecklas! Har du några frågor kontakta oss.</p>

<p>Ansvarig: intedinmamma</p>
</div>
	</div>
</div>
<div class="clear"> </div>
