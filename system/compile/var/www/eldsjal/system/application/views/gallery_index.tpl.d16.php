...
if (!function_exists('Dwoo_Plugin_tagcloud_4ad9d9cfc27a2')) {
function Dwoo_Plugin_tagcloud_4ad9d9cfc27a2(Dwoo $dwoo, $tags, $prefix) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9d9cfc27a2'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9d9cfc27a2'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_pager_4ad9d9cfc89a0')) {
function Dwoo_Plugin_pager_4ad9d9cfc89a0(Dwoo $dwoo, $pager) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9d9cfc89a0'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9d9cfc89a0'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_thumbnail_4ad9d9cfeabfd')) {
function Dwoo_Plugin_thumbnail_4ad9d9cfeabfd(Dwoo $dwoo, $image) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9d9cfeabfd'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9d9cfeabfd'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_input_4ad9d9cfebfad')) {
function Dwoo_Plugin_input_4ad9d9cfebfad(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4ad9d9cfebfad'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9d9cfebfad'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_messages_4ad9d9d035ed6')) {
function Dwoo_Plugin_messages_4ad9d9d035ed6(Dwoo $dwoo, $messages) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9d9d035ed6'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9d9d035ed6'.($_callCnt++)));
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4ad9d9cfebfad($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4ad9d9cfebfad($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4ad9d9cfebfad($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad9d9cfebfad($this, "password", "password", "Lösen: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad9d9cfebfad($this, "submit", "login", "", "Ja!", '');?>
...
<div id="content-wrap">
	<?php echo Dwoo_Plugin_messages_4ad9d9d035ed6($this, Dwoo_Plugin_getMessages($this));?>
...
/* -- foreach start output */
?>
	<?php echo Dwoo_Plugin_thumbnail_4ad9d9cfeabfd($this, (isset($this->scope["image"]) ? $this->scope["image"] : null));?>
...
<div class="clear"> </div>
<?php echo Dwoo_Plugin_pager_4ad9d9cfc89a0($this, (isset($this->scope["pager"]) ? $this->scope["pager"] : null));?>
...
<?php 
$_fh7_data = (isset($this->scope["tags"]) ? $this->scope["tags"] : null);
...
<?php echo Dwoo_Plugin_tagcloud_4ad9d9cfc27a2($this, (isset($this->scope["tagcloud"]) ? $this->scope["tagcloud"] : null), (isset($this->scope["tagcloud_prefix"]) ? $this->scope["tagcloud_prefix"] : null));?>
