...
if (!function_exists('Dwoo_Plugin_input_4ad746cb5f304')) {
function Dwoo_Plugin_input_4ad746cb5f304(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4ad746cb5f304'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad746cb5f304'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_datepager_4ad746cb75a7b')) {
function Dwoo_Plugin_datepager_4ad746cb75a7b(Dwoo $dwoo, $prefix, $year, $month = null, $day = null) {
static $_callCnt = 0;
$dwoo->scope[' 4ad746cb75a7b'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad746cb75a7b'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_calendar_4ad746cb7d7ae')) {
function Dwoo_Plugin_calendar_4ad746cb7d7ae(Dwoo $dwoo, $events, $month, $year) {
static $_callCnt = 0;
$dwoo->scope[' 4ad746cb7d7ae'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad746cb7d7ae'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_messages_4ad746cb87fb1')) {
function Dwoo_Plugin_messages_4ad746cb87fb1(Dwoo $dwoo, $messages) {
static $_callCnt = 0;
$dwoo->scope[' 4ad746cb87fb1'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad746cb87fb1'.($_callCnt++)));
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4ad746cb5f304($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4ad746cb5f304($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4ad746cb5f304($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad746cb5f304($this, "password", "password", "Lösen: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad746cb5f304($this, "submit", "login", "", "Ja!", '');?>
...
<div id="content-wrap">
	<?php echo Dwoo_Plugin_messages_4ad746cb87fb1($this, Dwoo_Plugin_getMessages($this));?>

<div id="content" class="container_16">
	<div class="grid_16">
<?php echo Dwoo_Plugin_datepager_4ad746cb75a7b($this, '/calendar/browse/', (isset($this->scope["year"]) ? $this->scope["year"] : null), (isset($this->scope["month"]) ? $this->scope["month"] : null), null);?>

<div class="calendar-month">
<?php echo Dwoo_Plugin_calendar_4ad746cb7d7ae($this, (isset($this->scope["events"]) ? $this->scope["events"] : null), (isset($this->scope["month"]) ? $this->scope["month"] : null), (isset($this->scope["year"]) ? $this->scope["year"] : null));?>
