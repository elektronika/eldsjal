...
if (!function_exists('Dwoo_Plugin_userlink_4ad948cceb9e2')) {
function Dwoo_Plugin_userlink_4ad948cceb9e2(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4ad948cceb9e2'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad948cceb9e2'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_actions_4ad948ccf0be0')) {
function Dwoo_Plugin_actions_4ad948ccf0be0(Dwoo $dwoo, $actions, $iconsonly = 1) {
static $_callCnt = 0;
$dwoo->scope[' 4ad948ccf0be0'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad948ccf0be0'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_input_4ad948cd1aa1a')) {
function Dwoo_Plugin_input_4ad948cd1aa1a(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4ad948cd1aa1a'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad948cd1aa1a'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_event_teaser_4ad948cd43a3f')) {
function Dwoo_Plugin_event_teaser_4ad948cd43a3f(Dwoo $dwoo, $data, $truncate = true) {
static $_callCnt = 0;
$dwoo->scope[' 4ad948cd43a3f'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad948cd43a3f'.($_callCnt++)));
...
?> <?php echo Dwoo_Plugin_fuzzytime($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'date',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), true, 'Y-m-d H:i');

}?>

			</span>
	</h3>
		<h4 class="subtitle"><span class="event-date"><?php echo Dwoo_Plugin_nicedate($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'date',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true));?> i <?php echo $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'locationName',  ),  3 =>   array (    0 => '',    1 => '',  ),), $dwoo->scope["data"], false);?></span> | Upplagd av <?php echo Dwoo_Plugin_userlink_4ad948cceb9e2($dwoo, (isset($dwoo->scope["data"]) ? $dwoo->scope["data"] : null));?> <?php echo Dwoo_Plugin_fuzzytime($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'created',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), true, 'Y-m-d H:i');?></h4>
...
?>
			<?php echo Dwoo_Plugin_rq($dwoo, Dwoo_Plugin_escape($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'body',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), 'html', null));?>

		<?php 
}?>

		<?php echo Dwoo_Plugin_actions_4ad948ccf0be0($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'actions',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), 1);?>
...
if (!function_exists('Dwoo_Plugin_signup_4ad948cd478a5')) {
function Dwoo_Plugin_signup_4ad948cd478a5(Dwoo $dwoo, $eventid) {
static $_callCnt = 0;
$dwoo->scope[' 4ad948cd478a5'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad948cd478a5'.($_callCnt++)));
$dwoo->scope['eventid'] = $eventid;
/* -- template start output */?>
<form class="signup" method="post" action="/calendar/signup/<?php echo $dwoo->scope["eventid"];?>">
	<input type="submit" value="Sign me up Scotty!"/>
</form>
<?php /* -- template end output */ $dwoo->setScope($_scope, true);
}
}
if (!function_exists('Dwoo_Plugin_signoff_4ad948cd48071')) {
function Dwoo_Plugin_signoff_4ad948cd48071(Dwoo $dwoo, $eventid) {
static $_callCnt = 0;
$dwoo->scope[' 4ad948cd48071'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad948cd48071'.($_callCnt++)));
$dwoo->scope['eventid'] = $eventid;
/* -- template start output */?>
<form class="signoff" method="post" action="/calendar/signoff/<?php echo $dwoo->scope["eventid"];?>">
	<input type="submit" value="Njae, jag ångrade mig!"/>
</form>
<?php /* -- template end output */ $dwoo->setScope($_scope, true);
}
}
if (!function_exists('Dwoo_Plugin_messages_4ad948cd4847d')) {
function Dwoo_Plugin_messages_4ad948cd4847d(Dwoo $dwoo, $messages) {
static $_callCnt = 0;
$dwoo->scope[' 4ad948cd4847d'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad948cd4847d'.($_callCnt++)));
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4ad948cd1aa1a($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4ad948cd1aa1a($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4ad948cd1aa1a($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad948cd1aa1a($this, "password", "password", "Lösen: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad948cd1aa1a($this, "submit", "login", "", "Ja!", '');?>
...
<div id="content-wrap">
	<?php echo Dwoo_Plugin_messages_4ad948cd4847d($this, Dwoo_Plugin_getMessages($this));?>

<div id="content" class="container_16">
	<div class="grid_16">
<div class="grid_12 alpha">
<?php echo Dwoo_Plugin_event_teaser_4ad948cd43a3f($this, (isset($this->scope["event"]) ? $this->scope["event"] : null), false);?>

</div>
<div class="grid_4 omega">
	<?php if ((isset($this->scope["user_has_signed_up"]) ? $this->scope["user_has_signed_up"] : null)) {
?>
		<?php echo Dwoo_Plugin_signoff_4ad948cd48071($this, $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'id',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["event"]) ? $this->scope["event"]:null), true));?>

	<?php 
}
else {
?>
		<?php echo Dwoo_Plugin_signup_4ad948cd478a5($this, $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'id',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["event"]) ? $this->scope["event"]:null), true));?>

	<?php 
}?>

	<?php if ((isset($this->scope["attendees"]) ? $this->scope["attendees"] : null)) {
?>
	<h3>Vi ska med!</h3>
	<ul>
		<?php 
$_fh6_data = (isset($this->scope["attendees"]) ? $this->scope["attendees"] : null);
...
/* -- foreach start output */
?>
			<li><?php echo Dwoo_Plugin_userlink_4ad948cceb9e2($this, (isset($this->scope["user"]) ? $this->scope["user"] : null));?></li>
		<?php 
/* -- foreach end output */
	}
}?>
