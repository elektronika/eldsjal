...
if (!function_exists('Dwoo_Plugin_input_4ad9b4514f5c9')) {
function Dwoo_Plugin_input_4ad9b4514f5c9(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4ad9b4514f5c9'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9b4514f5c9'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_textarea_4ad9b45156734')) {
function Dwoo_Plugin_textarea_4ad9b45156734(Dwoo $dwoo, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4ad9b45156734'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9b45156734'.($_callCnt++)));
$dwoo->scope['name'] = $name;
$dwoo->scope['label'] = $label;
$dwoo->scope['value'] = $value;
$dwoo->scope['error'] = $error;
...
if (!function_exists('Dwoo_Plugin_select_4ad9b4515bcdb')) {
function Dwoo_Plugin_select_4ad9b4515bcdb(Dwoo $dwoo, $name, $options, $default = "", $label = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4ad9b4515bcdb'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9b4515bcdb'.($_callCnt++)));
$dwoo->scope['name'] = $name;
...
if (!function_exists('Dwoo_Plugin_messages_4ad9b45177de4')) {
function Dwoo_Plugin_messages_4ad9b45177de4(Dwoo $dwoo, $messages) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9b45177de4'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9b45177de4'.($_callCnt++)));
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4ad9b4514f5c9($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4ad9b4514f5c9($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4ad9b4514f5c9($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad9b4514f5c9($this, "password", "password", "Lösen: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad9b4514f5c9($this, "submit", "login", "", "Ja!", '');?>
...
<div id="content-wrap">
	<?php echo Dwoo_Plugin_messages_4ad9b45177de4($this, Dwoo_Plugin_getMessages($this));?>

<div id="content" class="container_16">
	<div class="grid_16">
<?php echo form_open((isset($this->scope["form_action"]) ? $this->scope["form_action"] : null));?>

<?php if ((isset($this->scope["is_first_post"]) ? $this->scope["is_first_post"] : null)) {
?>
	<?php echo Dwoo_Plugin_input_4ad9b4514f5c9($this, "text", "title", "Rubrik", $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'title',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["topic"]) ? $this->scope["topic"]:null), true), '');?>

	<?php if ((isset($this->scope["is_moderator"]) ? $this->scope["is_moderator"] : null)) {
?>
		<?php echo Dwoo_Plugin_select_4ad9b4515bcdb($this, "category", (isset($this->scope["categories"]) ? $this->scope["categories"] : null), $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'category_id',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["topic"]) ? $this->scope["topic"]:null), true), "Kategori", '');?>

		<?php echo Dwoo_Plugin_input_4ad9b4514f5c9($this, "checkbox", "sticky", "Klistrad", '', '');?>

		<?php echo Dwoo_Plugin_input_4ad9b4514f5c9($this, "checkbox", "locked", "Låst", '', '');?>

		<?php echo Dwoo_Plugin_input_4ad9b4514f5c9($this, "checkbox", "is_news", "Nyhet", '', '');?>
...
<?php echo Dwoo_Plugin_textarea_4ad9b45156734($this, "body", "Inlägg", $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'body',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["post"]) ? $this->scope["post"]:null), true), '');?>

<?php echo Dwoo_Plugin_input_4ad9b4514f5c9($this, "submit", "submit", "", "Spara", '');?>
