...
if (!function_exists('Dwoo_Plugin_userlink_4ad99016197bc')) {
function Dwoo_Plugin_userlink_4ad99016197bc(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4ad99016197bc'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad99016197bc'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_userimage_4ad990161bebe')) {
function Dwoo_Plugin_userimage_4ad990161bebe(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4ad990161bebe'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad990161bebe'.($_callCnt++)));
$dwoo->scope['user'] = $user;
...
if (!function_exists('Dwoo_Plugin_actions_4ad990161e5ae')) {
function Dwoo_Plugin_actions_4ad990161e5ae(Dwoo $dwoo, $actions, $iconsonly = 1) {
static $_callCnt = 0;
$dwoo->scope[' 4ad990161e5ae'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad990161e5ae'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_input_4ad9901639b46')) {
function Dwoo_Plugin_input_4ad9901639b46(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4ad9901639b46'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9901639b46'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_inputs_4ad990164acbe')) {
function Dwoo_Plugin_inputs_4ad990164acbe(Dwoo $dwoo, $fields, $data) {
static $_callCnt = 0;
$dwoo->scope[' 4ad990164acbe'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad990164acbe'.($_callCnt++)));
$dwoo->scope['fields'] = $fields;
$dwoo->scope['data'] = $data;
/* -- template start output */?>
	<?php 
$_fh2_data = (isset($dwoo->scope["fields"]) ? $dwoo->scope["fields"] : null);
if ($dwoo->isArray($_fh2_data) === true)
{
	foreach ($_fh2_data as $dwoo->scope['field'])
	{
/* -- foreach start output */
?>
		<?php echo Dwoo_Plugin_input_4ad9901639b46($dwoo, 'text', (isset($dwoo->scope["field"]) ? $dwoo->scope["field"] : null), (isset($dwoo->scope["field"]) ? $dwoo->scope["field"] : null), $dwoo->readVar("data.".(isset($dwoo->scope["field"]) ? $dwoo->scope["field"] : null)), '');?>
...
if (!function_exists('Dwoo_Plugin_messages_4ad99016627a5')) {
function Dwoo_Plugin_messages_4ad99016627a5(Dwoo $dwoo, $messages) {
static $_callCnt = 0;
$dwoo->scope[' 4ad99016627a5'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad99016627a5'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_userbar_4ad9901662f75')) {
function Dwoo_Plugin_userbar_4ad9901662f75(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9901662f75'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9901662f75'.($_callCnt++)));
$dwoo->scope['user'] = $user;
/* -- template start output */?>
<div class="userbar">
	<div class="grid_2 alpha">
		<?php echo Dwoo_Plugin_userimage_4ad990161bebe($dwoo, (isset($dwoo->scope["user"]) ? $dwoo->scope["user"] : null));?>

	</div>
	<div class="grid_14 omega">
		<h2><?php echo $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'first_name',  ),  3 =>   array (    0 => '',    1 => '',  ),), $dwoo->scope["user"], false);?> "<span><?php echo Dwoo_Plugin_userlink_4ad99016197bc($dwoo, (isset($dwoo->scope["user"]) ? $dwoo->scope["user"] : null));?></span>" <?php echo $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'last_name',  ),  3 =>   array (    0 => '',    1 => '',  ),), $dwoo->scope["user"], false);?></h2>
...
?>, <span class="online">Online</span><?php 
		...
		<?php echo Dwoo_Plugin_actions_4ad990161e5ae($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'actions',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["user"]) ? $dwoo->scope["user"]:null), true), 0);?>
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4ad9901639b46($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4ad9901639b46($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4ad9901639b46($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad9901639b46($this, "password", "password", "Lösen: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad9901639b46($this, "submit", "login", "", "Ja!", '');?>
...
<div id="content-wrap">
	<?php echo Dwoo_Plugin_messages_4ad99016627a5($this, Dwoo_Plugin_getMessages($this));?>

<div id="content" class="container_16">
	<div class="grid_16">
<?php echo Dwoo_Plugin_userbar_4ad9901662f75($this, (isset($this->scope["user"]) ? $this->scope["user"] : null));?>

<?php echo form_open();?>

<?php echo Dwoo_Plugin_inputs_4ad990164acbe($this, (isset($this->scope["fields"]) ? $this->scope["fields"] : null), (isset($this->scope["user_array"]) ? $this->scope["user_array"] : null));?>

<?php echo Dwoo_Plugin_input_4ad9901639b46($this, 'submit', 'save', '', 'Spara', '');?>
