...
if (!function_exists('Dwoo_Plugin_input_4ada070f2f942')) {
function Dwoo_Plugin_input_4ada070f2f942(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4ada070f2f942'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ada070f2f942'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_messages_4ada070f5a8bc')) {
function Dwoo_Plugin_messages_4ada070f5a8bc(Dwoo $dwoo, $messages) {
static $_callCnt = 0;
$dwoo->scope[' 4ada070f5a8bc'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ada070f5a8bc'.($_callCnt++)));
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4ada070f2f942($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4ada070f2f942($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4ada070f2f942($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ada070f2f942($this, "password", "password", "Lösen: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ada070f2f942($this, "submit", "login", "", "Ja!", '');?>
...
<div id="content-wrap">
	<?php echo Dwoo_Plugin_messages_4ada070f5a8bc($this, Dwoo_Plugin_getMessages($this));?>

<div id="content" class="container_16">
	<div class="grid_16">
<p>Jepp. Det här är då den gloriösa framsidan. Där dom coola kidsen hänger.</p>
<p>Vad är det då som måste finnas här? Jo!</p>
<p><ul>
	<li>Senaste nyheter</li>
	<li>Senaste tankar</li>
	<li>Senaste bilder</li>
	<li>Senaste forumtrådar</li>
	<li>Dom närmsta eventen</li>
	<li>Någon fräck bild</li>
</ul></p>
<p>Eller som kidsen säger. Det senaste.</p>
	</div>
</div>
<div class="clear"> </div>
</div>
