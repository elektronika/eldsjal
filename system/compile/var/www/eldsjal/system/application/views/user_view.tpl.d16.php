...
if (!function_exists('Dwoo_Plugin_userlink_4ad9e5debbfba')) {
function Dwoo_Plugin_userlink_4ad9e5debbfba(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e5debbfba'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e5debbfba'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_userimage_4ad9e5debe69d')) {
function Dwoo_Plugin_userimage_4ad9e5debe69d(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e5debe69d'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e5debe69d'.($_callCnt++)));
$dwoo->scope['user'] = $user;
...
if (!function_exists('Dwoo_Plugin_actions_4ad9e5dec0d8d')) {
function Dwoo_Plugin_actions_4ad9e5dec0d8d(Dwoo $dwoo, $actions, $iconsonly = 1) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e5dec0d8d'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e5dec0d8d'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_input_4ad9e5dede248')) {
function Dwoo_Plugin_input_4ad9e5dede248(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e5dede248'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e5dede248'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_messages_4ad9e5df1c0f3')) {
function Dwoo_Plugin_messages_4ad9e5df1c0f3(Dwoo $dwoo, $messages) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e5df1c0f3'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e5df1c0f3'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_userbar_4ad9e5df1ccb6')) {
function Dwoo_Plugin_userbar_4ad9e5df1ccb6(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e5df1ccb6'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e5df1ccb6'.($_callCnt++)));
$dwoo->scope['user'] = $user;
/* -- template start output */?>
<div class="userbar">
	<div class="grid_2 alpha">
		<?php echo Dwoo_Plugin_userimage_4ad9e5debe69d($dwoo, (isset($dwoo->scope["user"]) ? $dwoo->scope["user"] : null));?>

	</div>
	<div class="grid_14 omega">
		<h2><?php echo $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'first_name',  ),  3 =>   array (    0 => '',    1 => '',  ),), $dwoo->scope["user"], false);?> "<span><?php echo Dwoo_Plugin_userlink_4ad9e5debbfba($dwoo, (isset($dwoo->scope["user"]) ? $dwoo->scope["user"] : null));?></span>" <?php echo $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'last_name',  ),  3 =>   array (    0 => '',    1 => '',  ),), $dwoo->scope["user"], false);?></h2>
...
?>, <span class="online">Online</span><?php 
		...
		<?php echo Dwoo_Plugin_actions_4ad9e5dec0d8d($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'actions',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["user"]) ? $dwoo->scope["user"]:null), true), 0);?>
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4ad9e5dede248($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4ad9e5dede248($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4ad9e5dede248($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad9e5dede248($this, "password", "password", "Lösen: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad9e5dede248($this, "submit", "login", "", "Ja!", '');?>
...
<div id="content-wrap">
	<?php echo Dwoo_Plugin_messages_4ad9e5df1c0f3($this, Dwoo_Plugin_getMessages($this));?>

<div id="content" class="container_16">
	<div class="grid_16">
<?php echo Dwoo_Plugin_userbar_4ad9e5df1ccb6($this, (isset($this->scope["user"]) ? $this->scope["user"] : null));?>

<div class="grid_10 alpha">
	<?php echo Dwoo_Plugin_rq($this, Dwoo_Plugin_escape($this, $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'presentation',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["user"]) ? $this->scope["user"]:null), true), 'html', null));?>
...
<div class="grid_6 omega">
	...
	<dl>
		<dt>E-mail</dt>
		<dd><?php echo Dwoo_Plugin_escape($this, $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'email',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["user"]) ? $this->scope["user"]:null), true), 'html', null);?></dd>
		<dt>MSN</dt>
		<dt><?php echo Dwoo_Plugin_escape($this, $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'msn',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["user"]) ? $this->scope["user"]:null), true), 'html', null);?></dt>
		<dt>ICQ</dt>
		<dt><?php echo Dwoo_Plugin_escape($this, $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'icq',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["user"]) ? $this->scope["user"]:null), true), 'html', null);?></dt>
		<dt>Telefon</dt>
		<dt><?php echo Dwoo_Plugin_escape($this, $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'phone',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["user"]) ? $this->scope["user"]:null), true), 'html', null);?></dt>
		<dt>Hemsida</dt>
		<dt><?php echo Dwoo_Plugin_escape($this, $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'webpage',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["user"]) ? $this->scope["user"]:null), true), 'html', null);?></dt>
	</dl>
	<h3>Sysslar med</h3>
	<ul><?php 
$_fh6_data = $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'does',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["user"]) ? $this->scope["user"]:null), true);
if ($this->isArray($_fh6_data) === true)
{
	foreach ($_fh6_data as $this->scope['do'])
	{
/* -- foreach start output */
?>
		<li><?php echo $this->scope["do"];?></li>
	<?php 
/* -- foreach end output */
	}
}?></ul>
