...
if (!function_exists('Dwoo_Plugin_userlink_4ad98ccbaf1a0')) {
function Dwoo_Plugin_userlink_4ad98ccbaf1a0(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4ad98ccbaf1a0'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad98ccbaf1a0'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_userimage_4ad98ccbb186e')) {
function Dwoo_Plugin_userimage_4ad98ccbb186e(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4ad98ccbb186e'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad98ccbb186e'.($_callCnt++)));
$dwoo->scope['user'] = $user;
...
if (!function_exists('Dwoo_Plugin_actions_4ad98ccbb3f7f')) {
function Dwoo_Plugin_actions_4ad98ccbb3f7f(Dwoo $dwoo, $actions, $iconsonly = 1) {
static $_callCnt = 0;
$dwoo->scope[' 4ad98ccbb3f7f'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad98ccbb3f7f'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_input_4ad98ccbd7605')) {
function Dwoo_Plugin_input_4ad98ccbd7605(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4ad98ccbd7605'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad98ccbd7605'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_messages_4ad98ccc173cb')) {
function Dwoo_Plugin_messages_4ad98ccc173cb(Dwoo $dwoo, $messages) {
static $_callCnt = 0;
$dwoo->scope[' 4ad98ccc173cb'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad98ccc173cb'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_userbar_4ad98ccc17f5e')) {
function Dwoo_Plugin_userbar_4ad98ccc17f5e(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4ad98ccc17f5e'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad98ccc17f5e'.($_callCnt++)));
$dwoo->scope['user'] = $user;
/* -- template start output */?>
<div class="userbar">
	<div class="grid_2 alpha">
		<?php echo Dwoo_Plugin_userimage_4ad98ccbb186e($dwoo, (isset($dwoo->scope["user"]) ? $dwoo->scope["user"] : null));?>

	</div>
	<div class="grid_14 omega">
		<h2><?php echo $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'first_name',  ),  3 =>   array (    0 => '',    1 => '',  ),), $dwoo->scope["user"], false);?> "<span><?php echo Dwoo_Plugin_userlink_4ad98ccbaf1a0($dwoo, (isset($dwoo->scope["user"]) ? $dwoo->scope["user"] : null));?></span>" <?php echo $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'last_name',  ),  3 =>   array (    0 => '',    1 => '',  ),), $dwoo->scope["user"], false);?></h2>
...
?>, <span class="online">Online</span><?php 
		...
		<?php echo Dwoo_Plugin_actions_4ad98ccbb3f7f($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'actions',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["user"]) ? $dwoo->scope["user"]:null), true), 0);?>
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4ad98ccbd7605($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4ad98ccbd7605($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4ad98ccbd7605($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad98ccbd7605($this, "password", "password", "Lösen: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad98ccbd7605($this, "submit", "login", "", "Ja!", '');?>
...
<div id="content-wrap">
	<?php echo Dwoo_Plugin_messages_4ad98ccc173cb($this, Dwoo_Plugin_getMessages($this));?>

<div id="content" class="container_16">
	<div class="grid_16">
<?php echo Dwoo_Plugin_userbar_4ad98ccc17f5e($this, (isset($this->scope["user"]) ? $this->scope["user"] : null));?>

<h3>Jag tycker att du ska ta en bra bild!</h3>
<?php echo form_open_multipart("/user/".$this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'slug',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["user"]) ? $this->scope["user"]:null), true)."/image");?>

<?php echo Dwoo_Plugin_input_4ad98ccbd7605($this, "file", "file", "Välj här!", '', '');?>

<?php echo Dwoo_Plugin_input_4ad98ccbd7605($this, 'submit', '', '', 'Ladda upp!', '');?>
