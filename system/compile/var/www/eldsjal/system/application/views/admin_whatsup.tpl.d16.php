...
if (!function_exists('Dwoo_Plugin_input_4ad9d88412ed2')) {
function Dwoo_Plugin_input_4ad9d88412ed2(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4ad9d88412ed2'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9d88412ed2'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_messages_4ad9d8843cae5')) {
function Dwoo_Plugin_messages_4ad9d8843cae5(Dwoo $dwoo, $messages) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9d8843cae5'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9d8843cae5'.($_callCnt++)));
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4ad9d88412ed2($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4ad9d88412ed2($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4ad9d88412ed2($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad9d88412ed2($this, "password", "password", "Lösen: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad9d88412ed2($this, "submit", "login", "", "Ja!", '');?>
...
<div id="content-wrap">
	<?php echo Dwoo_Plugin_messages_4ad9d8843cae5($this, Dwoo_Plugin_getMessages($this));?>

<div id="content" class="container_16">
	<div class="grid_16">
<?php echo form_open('/admin/whatsup');?>

<?php echo Dwoo_Plugin_input_4ad9d88412ed2($this, 'text', 'text', 'Meddelande', '', '');?>

<?php echo Dwoo_Plugin_input_4ad9d88412ed2($this, 'submit', 'save', '', 'Spara', '');?>
