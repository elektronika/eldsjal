...
if (!function_exists('Dwoo_Plugin_input_4ad76e0b7ce40')) {
function Dwoo_Plugin_input_4ad76e0b7ce40(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4ad76e0b7ce40'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad76e0b7ce40'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_textarea_4ad76e0b862a3')) {
function Dwoo_Plugin_textarea_4ad76e0b862a3(Dwoo $dwoo, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4ad76e0b862a3'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad76e0b862a3'.($_callCnt++)));
$dwoo->scope['name'] = $name;
$dwoo->scope['label'] = $label;
$dwoo->scope['value'] = $value;
$dwoo->scope['error'] = $error;
...
if (!function_exists('Dwoo_Plugin_select_4ad76e0b8bc76')) {
function Dwoo_Plugin_select_4ad76e0b8bc76(Dwoo $dwoo, $name, $options, $default = "", $label = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4ad76e0b8bc76'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad76e0b8bc76'.($_callCnt++)));
$dwoo->scope['name'] = $name;
...
if (!function_exists('Dwoo_Plugin_messages_4ad76e0ba473e')) {
function Dwoo_Plugin_messages_4ad76e0ba473e(Dwoo $dwoo, $messages) {
static $_callCnt = 0;
$dwoo->scope[' 4ad76e0ba473e'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad76e0ba473e'.($_callCnt++)));
...
if (!("1255617064" == filemtime('/var/www/eldsjal/system/application/views/templates.tpl'))) { ob_end_clean(); return false; };?>
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4ad76e0b7ce40($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4ad76e0b7ce40($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4ad76e0b7ce40($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad76e0b7ce40($this, "password", "password", "Lösen: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad76e0b7ce40($this, "submit", "login", "", "Ja!", '');?>
...
<div id="content-wrap">
	<?php echo Dwoo_Plugin_messages_4ad76e0ba473e($this, Dwoo_Plugin_getMessages($this));?>

<div id="content" class="container_16">
	<div class="grid_16">
<?php echo form_open('/forum/new');?>

<?php echo Dwoo_Plugin_input_4ad76e0b7ce40($this, "text", "title", "Rubrik", '', '');?>

<?php echo Dwoo_Plugin_select_4ad76e0b8bc76($this, "category", (isset($this->scope["categories"]) ? $this->scope["categories"] : null), (isset($this->scope["cat_id"]) ? $this->scope["cat_id"] : null), "Kategori", '');?>

<?php echo Dwoo_Plugin_textarea_4ad76e0b862a3($this, "body", "Inlägg", '', '');?>

<?php echo Dwoo_Plugin_input_4ad76e0b7ce40($this, "submit", "submit", "", "Spara", '');?>
