...
if (!function_exists('Dwoo_Plugin_userlink_4ad9fbe927d00')) {
function Dwoo_Plugin_userlink_4ad9fbe927d00(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9fbe927d00'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9fbe927d00'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_userimage_4ad9fbe92a7e5')) {
function Dwoo_Plugin_userimage_4ad9fbe92a7e5(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9fbe92a7e5'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9fbe92a7e5'.($_callCnt++)));
$dwoo->scope['user'] = $user;
...
if (!function_exists('Dwoo_Plugin_actions_4ad9fbe92cf2e')) {
function Dwoo_Plugin_actions_4ad9fbe92cf2e(Dwoo $dwoo, $actions, $iconsonly = 1) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9fbe92cf2e'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9fbe92cf2e'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_bubble_4ad9fbe9301c5')) {
function Dwoo_Plugin_bubble_4ad9fbe9301c5(Dwoo $dwoo, $data) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9fbe9301c5'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9fbe9301c5'.($_callCnt++)));
...
?><a name="post-<?php echo $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'id',  ),  3 =>   array (    0 => '',    1 => '',  ),), $dwoo->scope["data"], false);?>"></a><?php 
	...
	<div class="bubble-userdata">
		<?php echo Dwoo_Plugin_userimage_4ad9fbe92a7e5($dwoo, (isset($dwoo->scope["data"]) ? $dwoo->scope["data"] : null));?>

		<?php echo Dwoo_Plugin_userlink_4ad9fbe927d00($dwoo, (isset($dwoo->scope["data"]) ? $dwoo->scope["data"] : null));?>
	...
	<?php echo Dwoo_Plugin_fuzzytime($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'created',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), null, null, 'Y-m-d H:i');?> <?php echo Dwoo_Plugin_actions_4ad9fbe92cf2e($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'actions',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), 1);?>
...
if (!function_exists('Dwoo_Plugin_input_4ad9fbe94a7a3')) {
function Dwoo_Plugin_input_4ad9fbe94a7a3(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4ad9fbe94a7a3'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9fbe94a7a3'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_messages_4ad9fbe976e91')) {
function Dwoo_Plugin_messages_4ad9fbe976e91(Dwoo $dwoo, $messages) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9fbe976e91'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9fbe976e91'.($_callCnt++)));
...
'';// checking for modification in file:/var/www/eldsjal/system/application/views/people.tpl
if (!("1250465172" == filemtime('/var/www/eldsjal/system/application/views/people.tpl'))) { ob_end_clean(); return false; };
...
<head>
	<title>Eldsjäl<?php echo $this->assignInScope('people', 'active_section');?></title>
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4ad9fbe94a7a3($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4ad9fbe94a7a3($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4ad9fbe94a7a3($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad9fbe94a7a3($this, "password", "password", "Lösen: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad9fbe94a7a3($this, "submit", "login", "", "Ja!", '');?>
...
<div id="content-wrap">
	<?php echo Dwoo_Plugin_messages_4ad9fbe976e91($this, Dwoo_Plugin_getMessages($this));?>

<div id="content" class="container_16">
	<div class="grid_16">
<?php 
$_fh6_data = (isset($this->scope["people"]) ? $this->scope["people"] : null);
if ($this->isArray($_fh6_data) === true)
{
	foreach ($_fh6_data as $this->scope['dude'])
	{
/* -- foreach start output */
?>
	<?php echo Dwoo_Plugin_bubble_4ad9fbe9301c5($this, (isset($this->scope["dude"]) ? $this->scope["dude"] : null));?>
