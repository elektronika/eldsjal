...
if (!function_exists('Dwoo_Plugin_userlink_4ad9e3561e285')) {
function Dwoo_Plugin_userlink_4ad9e3561e285(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e3561e285'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e3561e285'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_userimage_4ad9e35620992')) {
function Dwoo_Plugin_userimage_4ad9e35620992(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e35620992'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e35620992'.($_callCnt++)));
$dwoo->scope['user'] = $user;
...
if (!function_exists('Dwoo_Plugin_actions_4ad9e356234aa')) {
function Dwoo_Plugin_actions_4ad9e356234aa(Dwoo $dwoo, $actions, $iconsonly = 1) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e356234aa'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e356234aa'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_bubble_4ad9e35627adb')) {
function Dwoo_Plugin_bubble_4ad9e35627adb(Dwoo $dwoo, $data) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e35627adb'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e35627adb'.($_callCnt++)));
...
?><a name="post-<?php echo $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'id',  ),  3 =>   array (    0 => '',    1 => '',  ),), $dwoo->scope["data"], false);?>"></a><?php 
	...
	<div class="bubble-userdata">
		<?php echo Dwoo_Plugin_userimage_4ad9e35620992($dwoo, (isset($dwoo->scope["data"]) ? $dwoo->scope["data"] : null));?>

		<?php echo Dwoo_Plugin_userlink_4ad9e3561e285($dwoo, (isset($dwoo->scope["data"]) ? $dwoo->scope["data"] : null));?>
	...
	<?php echo Dwoo_Plugin_fuzzytime($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'created',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), null, null, 'Y-m-d H:i');?> <?php echo Dwoo_Plugin_actions_4ad9e356234aa($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'actions',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), 1);?>
...
if (!function_exists('Dwoo_Plugin_input_4ad9e3563ea4e')) {
function Dwoo_Plugin_input_4ad9e3563ea4e(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e3563ea4e'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e3563ea4e'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_textarea_4ad9e356476f6')) {
function Dwoo_Plugin_textarea_4ad9e356476f6(Dwoo $dwoo, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e356476f6'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e356476f6'.($_callCnt++)));
$dwoo->scope['name'] = $name;
$dwoo->scope['label'] = $label;
$dwoo->scope['value'] = $value;
$dwoo->scope['error'] = $error;
...
if (!function_exists('Dwoo_Plugin_messages_4ad9e3566b503')) {
function Dwoo_Plugin_messages_4ad9e3566b503(Dwoo $dwoo, $messages) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e3566b503'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e3566b503'.($_callCnt++)));
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4ad9e3563ea4e($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4ad9e3563ea4e($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4ad9e3563ea4e($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad9e3563ea4e($this, "password", "password", "Lösen: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad9e3563ea4e($this, "submit", "login", "", "Ja!", '');?>
...
<div id="content-wrap">
	<?php echo Dwoo_Plugin_messages_4ad9e3566b503($this, Dwoo_Plugin_getMessages($this));?>
...
echo $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'forumCategoryName',  ),  3 =>   array (    0 => '',    1 => '',  ),), $this->scope["topic"], false);?></a> &raquo; <?php echo $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'title',  ),  3 =>   array (    0 => '',    1 => '',  ),), $this->scope["topic"], false);?></h2>
...
/* -- foreach start output */
?>
	<?php echo Dwoo_Plugin_bubble_4ad9e35627adb($this, (isset($this->scope["post"]) ? $this->scope["post"] : null));?>
...
?>
<?php echo form_open("/forum/topic/".$this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'id',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["topic"]) ? $this->scope["topic"]:null), true)."");?>

<?php echo Dwoo_Plugin_textarea_4ad9e356476f6($this, "body", "Inlägg", '', '');?>

<?php echo Dwoo_Plugin_input_4ad9e3563ea4e($this, "submit", "submit", "", "Spara", '');?>
