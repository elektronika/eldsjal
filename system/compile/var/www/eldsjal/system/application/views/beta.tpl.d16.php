...
if (!function_exists('Dwoo_Plugin_input_4ad9e03c5871c')) {
function Dwoo_Plugin_input_4ad9e03c5871c(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e03c5871c'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e03c5871c'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_messages_4ad9e03cc834c')) {
function Dwoo_Plugin_messages_4ad9e03cc834c(Dwoo $dwoo, $messages) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e03cc834c'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e03cc834c'.($_callCnt++)));
...
<head>
	<title>Eldsjäl - Vad brinner du för?</title>
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4ad9e03c5871c($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4ad9e03c5871c($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4ad9e03c5871c($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad9e03c5871c($this, "password", "password", "Lösen: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad9e03c5871c($this, "submit", "login", "", "Ja!", '');?>
...
<div id="content-wrap">
	<?php echo Dwoo_Plugin_messages_4ad9e03cc834c($this, Dwoo_Plugin_getMessages($this));?>

<div id="content" class="container_12">
	<div class="grid_16">
<div class="grid_8 alpha">
<h2>Tjohej!</h2>
<p><b>Välkommen till beta-versionen utav nya eldsjal.org!</b></p>
<p>Det ser lite halvklart ut på sina ställen, och det är ungefär vad det är. Det är trots allt en beta-version, men det är fritt fram att använda. Och det är just det vi vill att ni ska göra. För på så sätt kan vi hitta buggar och konstigheter, och rätta till dom innan vi går över helt till den nya versionen.</p>
<p>Om du hittar något som du tycker ser konstigt ut så är det bara att hojta till i forumet, eller i någon gästbok som verkar ha med saken att göra.</p>
<p><b>Kram!</b></p>
<p>//<a href="/user/intedinmamma" class="user u5122">intedinmamma</a></p>
<p style="font-size: 10px">ps. Vill du hjälpa till lite mer konkret? Kan du PHP, MVC, SQL, BZR och andra roliga förkortningar? Hojta gärna till, vi behöver påfyllning! :) ds.</p>
</div>
<div class="grid_4 omega">
	<h2>&nbsp;</h2>
	<h3>Detta är nytt (bland annat)</h3>
	<ul>
		<li>Års-, månads- och dagsöversikt i kalendern.</li>
		<li>Helt nytt galleri.</li>
		<li>Möjlighet att filtrera på flera kategorier i galleriet</li>
		<li>Slumpad bild.</li>
		<li>Slumpad forumtråd.</li>
		<li>För muspekaren över användarnamn för mer info.</li>
	</ul>
	<p>&nbsp;</p>
	<p>Och mer är på gång...</p>
</div>
	</div>
</div>
<div class="clear"> </div>
