...
if (!function_exists('Dwoo_Plugin_userlink_4ad9e5e6561f0')) {
function Dwoo_Plugin_userlink_4ad9e5e6561f0(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e5e6561f0'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e5e6561f0'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_userimage_4ad9e5e65890e')) {
function Dwoo_Plugin_userimage_4ad9e5e65890e(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e5e65890e'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e5e65890e'.($_callCnt++)));
$dwoo->scope['user'] = $user;
...
if (!function_exists('Dwoo_Plugin_pager_4ad9e5e659c4f')) {
function Dwoo_Plugin_pager_4ad9e5e659c4f(Dwoo $dwoo, $pager) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e5e659c4f'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e5e659c4f'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_actions_4ad9e5e65afdc')) {
function Dwoo_Plugin_actions_4ad9e5e65afdc(Dwoo $dwoo, $actions, $iconsonly = 1) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e5e65afdc'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e5e65afdc'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_bubble_4ad9e5e65e301')) {
function Dwoo_Plugin_bubble_4ad9e5e65e301(Dwoo $dwoo, $data) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e5e65e301'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e5e65e301'.($_callCnt++)));
...
?><a name="post-<?php echo $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'id',  ),  3 =>   array (    0 => '',    1 => '',  ),), $dwoo->scope["data"], false);?>"></a><?php 
	...
	<div class="bubble-userdata">
		<?php echo Dwoo_Plugin_userimage_4ad9e5e65890e($dwoo, (isset($dwoo->scope["data"]) ? $dwoo->scope["data"] : null));?>

		<?php echo Dwoo_Plugin_userlink_4ad9e5e6561f0($dwoo, (isset($dwoo->scope["data"]) ? $dwoo->scope["data"] : null));?>

	</div>
	<div class="bubble-content-wrap">
		<div class="bubble-content">
			<?php echo Dwoo_Plugin_rq($dwoo, nl2br((string) Dwoo_Plugin_escape($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'body',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), 'html', null)));?>

		</div>
	</div>
	<div class="bubble-meta">
	<?php echo Dwoo_Plugin_fuzzytime($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'created',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), null, null, 'Y-m-d H:i');?> <?php echo Dwoo_Plugin_actions_4ad9e5e65afdc($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'actions',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), 1);?>
...
if (!function_exists('Dwoo_Plugin_input_4ad9e5e67423a')) {
function Dwoo_Plugin_input_4ad9e5e67423a(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e5e67423a'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e5e67423a'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_messages_4ad9e5e69d270')) {
function Dwoo_Plugin_messages_4ad9e5e69d270(Dwoo $dwoo, $messages) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e5e69d270'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e5e69d270'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_userbar_4ad9e5e69e276')) {
function Dwoo_Plugin_userbar_4ad9e5e69e276(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e5e69e276'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e5e69e276'.($_callCnt++)));
$dwoo->scope['user'] = $user;
/* -- template start output */?>
<div class="userbar">
	<div class="grid_2 alpha">
		<?php echo Dwoo_Plugin_userimage_4ad9e5e65890e($dwoo, (isset($dwoo->scope["user"]) ? $dwoo->scope["user"] : null));?>

	</div>
	<div class="grid_14 omega">
		<h2><?php echo $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'first_name',  ),  3 =>   array (    0 => '',    1 => '',  ),), $dwoo->scope["user"], false);?> "<span><?php echo Dwoo_Plugin_userlink_4ad9e5e6561f0($dwoo, (isset($dwoo->scope["user"]) ? $dwoo->scope["user"] : null));?></span>" <?php echo $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'last_name',  ),  3 =>   array (    0 => '',    1 => '',  ),), $dwoo->scope["user"], false);?></h2>
...
?>, <span class="online">Online</span><?php 
		...
		<h4>Gick med <?php echo Dwoo_Plugin_fuzzytime($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'register_date',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["user"]) ? $dwoo->scope["user"]:null), true), null, null, 'Y-m-d H:i');?>, loggade senast in <?php echo Dwoo_Plugin_fuzzytime($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'lastLogin',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["user"]) ? $dwoo->scope["user"]:null), true), null, null, 'Y-m-d H:i');?></h4>
		<?php echo Dwoo_Plugin_actions_4ad9e5e65afdc($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'actions',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["user"]) ? $dwoo->scope["user"]:null), true), 0);?>
...
'';// checking for modification in file:/var/www/eldsjal/system/application/views/guestbook.tpl
if (!("1250355118" == filemtime('/var/www/eldsjal/system/application/views/guestbook.tpl'))) { ob_end_clean(); return false; };
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4ad9e5e67423a($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4ad9e5e67423a($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4ad9e5e67423a($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad9e5e67423a($this, "password", "password", "Lösen: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad9e5e67423a($this, "submit", "login", "", "Ja!", '');?>
...
<div id="content-wrap">
	<?php echo Dwoo_Plugin_messages_4ad9e5e69d270($this, Dwoo_Plugin_getMessages($this));?>

<div id="content" class="container_16">
	<div class="grid_16">
<?php echo Dwoo_Plugin_userbar_4ad9e5e69e276($this, (isset($this->scope["user"]) ? $this->scope["user"] : null));?>

<div id="guestbook">
<?php 
$_fh6_data = (isset($this->scope["posts"]) ? $this->scope["posts"] : null);
...
/* -- foreach start output */
?>
	<?php echo Dwoo_Plugin_bubble_4ad9e5e65e301($this, (isset($this->scope["post"]) ? $this->scope["post"] : null));?>
...
<?php echo Dwoo_Plugin_pager_4ad9e5e659c4f($this, (isset($this->scope["pager"]) ? $this->scope["pager"] : null));?>
