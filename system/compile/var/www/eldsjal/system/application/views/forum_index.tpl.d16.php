...
if (!function_exists('Dwoo_Plugin_input_4ad9f50a56d06')) {
function Dwoo_Plugin_input_4ad9f50a56d06(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4ad9f50a56d06'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9f50a56d06'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_messages_4ad9f50a81c94')) {
function Dwoo_Plugin_messages_4ad9f50a81c94(Dwoo $dwoo, $messages) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9f50a81c94'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9f50a81c94'.($_callCnt++)));
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4ad9f50a56d06($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4ad9f50a56d06($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4ad9f50a56d06($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad9f50a56d06($this, "password", "password", "Lösen: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad9f50a56d06($this, "submit", "login", "", "Ja!", '');?>
...
<div id="content-wrap">
	<?php echo Dwoo_Plugin_messages_4ad9f50a81c94($this, Dwoo_Plugin_getMessages($this));?>
...
<table id="forum-categories">
	...
	<tbody>
<?php 
$_fh6_data = (isset($this->scope["categories"]) ? $this->scope["categories"] : null);
if ($this->isArray($_fh6_data) === true)
{
	foreach ($_fh6_data as $this->scope['cat'])
	{
/* -- foreach start output */
?>
	<tr class="<?php echo implode(' ', $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'classes',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["cat"]) ? $this->scope["cat"]:null), true));?>">
		<td class="category-title"><?php echo '<a href="'."".$this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'href',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["cat"]) ? $this->scope["cat"]:null), true)."".'">';
echo $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'title',  ),  3 =>   array (    0 => '',    1 => '',  ),), $this->scope["cat"], false);?></a><span> - <?php echo $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'description',  ),  3 =>   array (    0 => '',    1 => '',  ),), $this->scope["cat"], false);?></span></td>
		<td class="category-threads"><?php echo $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'threads',  ),  3 =>   array (    0 => '',    1 => '',  ),), $this->scope["cat"], false);?></td>
		<td class="category-updated"><?php echo Dwoo_Plugin_fuzzytime($this, $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'updated',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["cat"]) ? $this->scope["cat"]:null), true), '', ' sedan', 'Y-m-d H:i');?></td>
	</tr>
<?php 
/* -- foreach end output */
	}
