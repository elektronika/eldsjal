...
if (!function_exists('Dwoo_Plugin_userlink_4ad9faa356663')) {
function Dwoo_Plugin_userlink_4ad9faa356663(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9faa356663'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9faa356663'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_input_4ad9faa37529b')) {
function Dwoo_Plugin_input_4ad9faa37529b(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4ad9faa37529b'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9faa37529b'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_messages_4ad9faa39fa09')) {
function Dwoo_Plugin_messages_4ad9faa39fa09(Dwoo $dwoo, $messages) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9faa39fa09'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9faa39fa09'.($_callCnt++)));
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4ad9faa37529b($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4ad9faa37529b($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4ad9faa37529b($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad9faa37529b($this, "password", "password", "Lösen: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad9faa37529b($this, "submit", "login", "", "Ja!", '');?>
...
<div id="content-wrap">
	<?php echo Dwoo_Plugin_messages_4ad9faa39fa09($this, Dwoo_Plugin_getMessages($this));?>
...
<dl id="alerts">
<?php 
$_fh7_data = (isset($this->scope["alerts"]) ? $this->scope["alerts"] : null);
$this->globals["foreach"]['default'] = array
(
	"index"		=> 0,
	"first"		=> null,
);
$_fh7_glob =& $this->globals["foreach"]['default'];
if ($this->isArray($_fh7_data) === true)
{
	foreach ($_fh7_data as $this->scope["title"]=>$this->scope["alert_group"])
	{
		$_fh7_glob["first"] = (string) ($_fh7_glob["index"] === 0);
/* -- foreach start output */
?>
...
?> class="first"<?php 
		...
		<?php 
$_fh6_data = (isset($this->scope["alert_group"]) ? $this->scope["alert_group"] : null);
if ($this->isArray($_fh6_data) === true)
{
	foreach ($_fh6_data as $this->scope['alert'])
	{
/* -- foreach start output */
?>
...
?>av <?php echo Dwoo_Plugin_userlink_4ad9faa356663($this, (isset($this->scope["alert"]) ? $this->scope["alert"] : null));
...
echo Dwoo_Plugin_fuzzytime($this, $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'date',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["alert"]) ? $this->scope["alert"]:null), true), null, null, 'Y-m-d H:i');
