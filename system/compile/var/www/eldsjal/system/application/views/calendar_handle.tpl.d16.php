...
if (!function_exists('Dwoo_Plugin_input_4a8990908e78c')) {
function Dwoo_Plugin_input_4a8990908e78c(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4a8990908e78c'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a8990908e78c'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_textarea_4a89909094d41')) {
function Dwoo_Plugin_textarea_4a89909094d41(Dwoo $dwoo, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4a89909094d41'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a89909094d41'.($_callCnt++)));
$dwoo->scope['name'] = $name;
$dwoo->scope['label'] = $label;
$dwoo->scope['value'] = $value;
$dwoo->scope['error'] = $error;
...
if (!function_exists('Dwoo_Plugin_select_4a89909099f01')) {
function Dwoo_Plugin_select_4a89909099f01(Dwoo $dwoo, $name, $options, $default = "", $label = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4a89909099f01'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a89909099f01'.($_callCnt++)));
$dwoo->scope['name'] = $name;
...
if (!function_exists('Dwoo_Plugin_messages_4a899090b1276')) {
function Dwoo_Plugin_messages_4a899090b1276(Dwoo $dwoo, $messages) {
static $_callCnt = 0;
$dwoo->scope[' 4a899090b1276'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a899090b1276'.($_callCnt++)));
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4a8990908e78c($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4a8990908e78c($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4a8990908e78c($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4a8990908e78c($this, "password", "password", "Lösen: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4a8990908e78c($this, "submit", "login", "", "Ja!", '');?>
...
<div id="content-wrap">
	<?php echo Dwoo_Plugin_messages_4a899090b1276($this, Dwoo_Plugin_getMessages($this));?>

<div id="content" class="container_16">
	<div class="grid_16">
<?php echo form_open_multipart((isset($this->scope["form_action"]) ? $this->scope["form_action"] : null));?>

<?php echo Dwoo_Plugin_input_4a8990908e78c($this, 'text', 'title', 'Rubrik', $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'title',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["event"]) ? $this->scope["event"]:null), true), '');?>

<?php echo Dwoo_Plugin_input_4a8990908e78c($this, 'text', 'date-show', 'Datum', '', '');?>

<?php echo Dwoo_Plugin_input_4a8990908e78c($this, 'hidden', 'date', '', $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'date',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["event"]) ? $this->scope["event"]:null), true), '');?>

<?php echo Dwoo_Plugin_textarea_4a89909094d41($this, 'body', 'Beskrivning', $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'body',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["event"]) ? $this->scope["event"]:null), true), '');?>

<?php echo Dwoo_Plugin_input_4a8990908e78c($this, "file", "file", "Bifoga en bild (valfritt)", '', '');?>

<?php echo Dwoo_Plugin_select_4a89909099f01($this, "location", (isset($this->scope["locations"]) ? $this->scope["locations"] : null), "", "Område", '');?>

<?php echo Dwoo_Plugin_input_4a8990908e78c($this, "checkbox", "informall", 'Informera hela landet', '', '');?>

<?php echo Dwoo_Plugin_input_4a8990908e78c($this, 'submit', 'save', '', 'Spara', '');?>
