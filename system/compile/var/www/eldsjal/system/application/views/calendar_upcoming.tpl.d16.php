...
if (!function_exists('Dwoo_Plugin_userlink_4a8949903ff29')) {
function Dwoo_Plugin_userlink_4a8949903ff29(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4a8949903ff29'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a8949903ff29'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_actions_4a89499044916')) {
function Dwoo_Plugin_actions_4a89499044916(Dwoo $dwoo, $actions) {
static $_callCnt = 0;
$dwoo->scope[' 4a89499044916'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a89499044916'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_input_4a8949905b09f')) {
function Dwoo_Plugin_input_4a8949905b09f(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4a8949905b09f'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a8949905b09f'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_event_teaser_4a8949907b063')) {
function Dwoo_Plugin_event_teaser_4a8949907b063(Dwoo $dwoo, $data, $truncate = true) {
static $_callCnt = 0;
$dwoo->scope[' 4a8949907b063'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a8949907b063'.($_callCnt++)));
...
?> <?php echo Dwoo_Plugin_fuzzytime($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'date',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), true, 'Y-m-d H:i');
		...
		<h4 class="subtitle"><span class="event-date"><?php echo Dwoo_Plugin_nicedate($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'date',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true));?> i <?php echo $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'locationName',  ),  3 =>   array (    0 => '',    1 => '',  ),), $dwoo->scope["data"], false);?></span> | Upplagd av <?php echo Dwoo_Plugin_userlink_4a8949903ff29($dwoo, (isset($dwoo->scope["data"]) ? $dwoo->scope["data"] : null));?> <?php echo Dwoo_Plugin_fuzzytime($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'created',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), true, 'Y-m-d H:i');?></h4>
...
?>
		...
		<?php echo Dwoo_Plugin_actions_4a89499044916($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'actions',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true));?>
...
if (!function_exists('Dwoo_Plugin_messages_4a8949907db56')) {
function Dwoo_Plugin_messages_4a8949907db56(Dwoo $dwoo, $messages) {
static $_callCnt = 0;
$dwoo->scope[' 4a8949907db56'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a8949907db56'.($_callCnt++)));
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4a8949905b09f($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4a8949905b09f($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4a8949905b09f($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4a8949905b09f($this, "password", "password", "Lösen: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4a8949905b09f($this, "submit", "login", "", "Ja!", '');?>
...
<div id="content-wrap">
	<?php echo Dwoo_Plugin_messages_4a8949907db56($this, Dwoo_Plugin_getMessages($this));?>
...
/* -- foreach start output */
?>
		<?php echo Dwoo_Plugin_event_teaser_4a8949907b063($this, (isset($this->scope["event"]) ? $this->scope["event"] : null), true);?>
