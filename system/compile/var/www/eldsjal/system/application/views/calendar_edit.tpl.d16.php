...
if (!function_exists('Dwoo_Plugin_input_4a873163d1dee')) {
function Dwoo_Plugin_input_4a873163d1dee(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4a873163d1dee'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a873163d1dee'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_textarea_4a873163d6c11')) {
function Dwoo_Plugin_textarea_4a873163d6c11(Dwoo $dwoo, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4a873163d6c11'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a873163d6c11'.($_callCnt++)));
$dwoo->scope['name'] = $name;
$dwoo->scope['label'] = $label;
$dwoo->scope['value'] = $value;
$dwoo->scope['error'] = $error;
...
if (!function_exists('Dwoo_Plugin_select_4a873163db675')) {
function Dwoo_Plugin_select_4a873163db675(Dwoo $dwoo, $name, $options, $default = "", $label = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4a873163db675'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a873163db675'.($_callCnt++)));
$dwoo->scope['name'] = $name;
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4a873163d1dee($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4a873163d1dee($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4a873163d1dee($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4a873163d1dee($this, "password", "password", "Lösen: ", '', '');?>
...
<?php echo form_open_multipart('calendar/edit');?>

<?php echo Dwoo_Plugin_input_4a873163d1dee($this, 'text', 'title', 'Rubrik', $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'title',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["event"]) ? $this->scope["event"]:null), true), '');?>

<?php echo Dwoo_Plugin_input_4a873163d1dee($this, 'text', 'date', 'Datum', $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'date',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["event"]) ? $this->scope["event"]:null), true), '');?>

<?php echo Dwoo_Plugin_textarea_4a873163d6c11($this, 'body', 'Beskrivning', $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'body',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["event"]) ? $this->scope["event"]:null), true), '');?>

<?php echo Dwoo_Plugin_input_4a873163d1dee($this, "file", "file", "Bifoga en bild (valfritt)", '', '');?>

<?php echo Dwoo_Plugin_select_4a873163db675($this, "location", (isset($this->scope["locations"]) ? $this->scope["locations"] : null), "", "Område", '');?>

<?php echo Dwoo_Plugin_input_4a873163d1dee($this, "checkbox", "informall", 'Informera hela landet', '', '');?>

<?php echo Dwoo_Plugin_input_4a873163d1dee($this, 'submit', 'save', '', 'Spara', '');?>
