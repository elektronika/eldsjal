...
if (!function_exists('Dwoo_Plugin_userlink_4ad9e5facc251')) {
function Dwoo_Plugin_userlink_4ad9e5facc251(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e5facc251'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e5facc251'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_actions_4ad9e5fad2460')) {
function Dwoo_Plugin_actions_4ad9e5fad2460(Dwoo $dwoo, $actions, $iconsonly = 1) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e5fad2460'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e5fad2460'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_teaser_4ad9e5fada4b8')) {
function Dwoo_Plugin_teaser_4ad9e5fada4b8(Dwoo $dwoo, $data, $truncate = true) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e5fada4b8'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e5fada4b8'.($_callCnt++)));
...
?> av <?php echo Dwoo_Plugin_userlink_4ad9e5facc251($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'creator',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true));
...
?> av <?php echo Dwoo_Plugin_userlink_4ad9e5facc251($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'updater',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true));
...
?> av <?php echo Dwoo_Plugin_userlink_4ad9e5facc251($dwoo, (isset($dwoo->scope["data"]) ? $dwoo->scope["data"] : null));
...
?>
		...
		<?php echo Dwoo_Plugin_actions_4ad9e5fad2460($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'actions',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), 1);?>
...
if (!function_exists('Dwoo_Plugin_input_4ad9e5faec9e2')) {
function Dwoo_Plugin_input_4ad9e5faec9e2(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e5faec9e2'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e5faec9e2'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_messages_4ad9e5fb22f47')) {
function Dwoo_Plugin_messages_4ad9e5fb22f47(Dwoo $dwoo, $messages) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e5fb22f47'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e5fb22f47'.($_callCnt++)));
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4ad9e5faec9e2($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4ad9e5faec9e2($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4ad9e5faec9e2($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad9e5faec9e2($this, "password", "password", "Lösen: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad9e5faec9e2($this, "submit", "login", "", "Ja!", '');?>
...
<div id="content-wrap">
	<?php echo Dwoo_Plugin_messages_4ad9e5fb22f47($this, Dwoo_Plugin_getMessages($this));?>

<div id="content" class="container_16">
	<div class="grid_16">
<div id="image">
	<div id="image-border">
		<img src="<?php echo $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'src',  ),  3 =>   array (    0 => '',    1 => '',  ),), $this->scope["image"], false);?>" alt="<?php echo $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'title',  ),  3 =>   array (    0 => '',    1 => '',  ),), $this->scope["image"], false);?>"/>
	</div>
	<?php echo Dwoo_Plugin_teaser_4ad9e5fada4b8($this, (isset($this->scope["image"]) ? $this->scope["image"] : null), false);?>
