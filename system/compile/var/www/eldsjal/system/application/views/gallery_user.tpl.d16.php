...
if (!function_exists('Dwoo_Plugin_userlink_4ad9d858736c8')) {
function Dwoo_Plugin_userlink_4ad9d858736c8(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9d858736c8'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9d858736c8'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_userimage_4ad9d85876178')) {
function Dwoo_Plugin_userimage_4ad9d85876178(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9d85876178'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9d85876178'.($_callCnt++)));
$dwoo->scope['user'] = $user;
...
if (!function_exists('Dwoo_Plugin_actions_4ad9d85879443')) {
function Dwoo_Plugin_actions_4ad9d85879443(Dwoo $dwoo, $actions, $iconsonly = 1) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9d85879443'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9d85879443'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_thumbnail_4ad9d85893a6d')) {
function Dwoo_Plugin_thumbnail_4ad9d85893a6d(Dwoo $dwoo, $image) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9d85893a6d'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9d85893a6d'.($_callCnt++)));
$dwoo->scope['image'] = $image;
/* -- template start output */?>
<a href="/gallery/view/<?php echo $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'imageId',  ),  3 =>   array (    0 => '',    1 => '',  ),), $dwoo->scope["image"], false);?>" class="thumbnail image-<?php echo $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'imageId',  ),  3 =>   array (    0 => '',    1 => '',  ),), $dwoo->scope["image"], false);?>" style="background-image: url('/uploads/galleryImages/tn_<?php echo $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'imageId',  ),  3 =>   array (    0 => '',    1 => '',  ),), $dwoo->scope["image"], false);?>.jpg')" title="<?php echo $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'imageName',  ),  3 =>   array (    0 => '',    1 => '',  ),), $dwoo->scope["image"], false);?>"> </a>
<?php /* -- template end output */ $dwoo->setScope($_scope, true);
}
}
if (!function_exists('Dwoo_Plugin_input_4ad9d85894dd2')) {
function Dwoo_Plugin_input_4ad9d85894dd2(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4ad9d85894dd2'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9d85894dd2'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_messages_4ad9d858c4f23')) {
function Dwoo_Plugin_messages_4ad9d858c4f23(Dwoo $dwoo, $messages) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9d858c4f23'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9d858c4f23'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_userbar_4ad9d858c5ae2')) {
function Dwoo_Plugin_userbar_4ad9d858c5ae2(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9d858c5ae2'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9d858c5ae2'.($_callCnt++)));
$dwoo->scope['user'] = $user;
/* -- template start output */?>
<div class="userbar">
	<div class="grid_2 alpha">
		<?php echo Dwoo_Plugin_userimage_4ad9d85876178($dwoo, (isset($dwoo->scope["user"]) ? $dwoo->scope["user"] : null));?>

	</div>
	<div class="grid_14 omega">
		<h2><?php echo $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'first_name',  ),  3 =>   array (    0 => '',    1 => '',  ),), $dwoo->scope["user"], false);?> "<span><?php echo Dwoo_Plugin_userlink_4ad9d858736c8($dwoo, (isset($dwoo->scope["user"]) ? $dwoo->scope["user"] : null));?></span>" <?php echo $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'last_name',  ),  3 =>   array (    0 => '',    1 => '',  ),), $dwoo->scope["user"], false);?></h2>
...
?>, <span class="online">Online</span><?php 
		...
		<?php echo Dwoo_Plugin_actions_4ad9d85879443($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'actions',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["user"]) ? $dwoo->scope["user"]:null), true), 0);?>
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4ad9d85894dd2($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4ad9d85894dd2($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4ad9d85894dd2($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad9d85894dd2($this, "password", "password", "Lösen: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad9d85894dd2($this, "submit", "login", "", "Ja!", '');?>
...
<div id="content-wrap">
	<?php echo Dwoo_Plugin_messages_4ad9d858c4f23($this, Dwoo_Plugin_getMessages($this));?>

<div id="content" class="container_16">
	<div class="grid_16">
<?php echo Dwoo_Plugin_userbar_4ad9d858c5ae2($this, (isset($this->scope["user"]) ? $this->scope["user"] : null));?>

<?php 
$_fh6_data = (isset($this->scope["images"]) ? $this->scope["images"] : null);
if ($this->isArray($_fh6_data) === true)
{
	foreach ($_fh6_data as $this->scope['image'])
	{
/* -- foreach start output */
?>
	<?php echo Dwoo_Plugin_thumbnail_4ad9d85893a6d($this, (isset($this->scope["image"]) ? $this->scope["image"] : null));?>
