...
if (!function_exists('Dwoo_Plugin_userlink_4ad9e654de1be')) {
function Dwoo_Plugin_userlink_4ad9e654de1be(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e654de1be'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e654de1be'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_userimage_4ad9e654e0c92')) {
function Dwoo_Plugin_userimage_4ad9e654e0c92(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e654e0c92'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e654e0c92'.($_callCnt++)));
$dwoo->scope['user'] = $user;
...
if (!function_exists('Dwoo_Plugin_actions_4ad9e654e33a6')) {
function Dwoo_Plugin_actions_4ad9e654e33a6(Dwoo $dwoo, $actions, $iconsonly = 1) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e654e33a6'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e654e33a6'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_teaser_4ad9e654ec023')) {
function Dwoo_Plugin_teaser_4ad9e654ec023(Dwoo $dwoo, $data, $truncate = true) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e654ec023'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e654ec023'.($_callCnt++)));
...
?> av <?php echo Dwoo_Plugin_userlink_4ad9e654de1be($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'creator',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true));
...
?> av <?php echo Dwoo_Plugin_userlink_4ad9e654de1be($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'updater',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true));
...
?> av <?php echo Dwoo_Plugin_userlink_4ad9e654de1be($dwoo, (isset($dwoo->scope["data"]) ? $dwoo->scope["data"] : null));
...
?>
		...
		<?php echo Dwoo_Plugin_actions_4ad9e654e33a6($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'actions',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), 1);?>
...
if (!function_exists('Dwoo_Plugin_input_4ad9e6550a2dd')) {
function Dwoo_Plugin_input_4ad9e6550a2dd(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e6550a2dd'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e6550a2dd'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_messages_4ad9e6553bfd6')) {
function Dwoo_Plugin_messages_4ad9e6553bfd6(Dwoo $dwoo, $messages) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e6553bfd6'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e6553bfd6'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_userbar_4ad9e6553c7f0')) {
function Dwoo_Plugin_userbar_4ad9e6553c7f0(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e6553c7f0'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e6553c7f0'.($_callCnt++)));
$dwoo->scope['user'] = $user;
/* -- template start output */?>
<div class="userbar">
	<div class="grid_2 alpha">
		<?php echo Dwoo_Plugin_userimage_4ad9e654e0c92($dwoo, (isset($dwoo->scope["user"]) ? $dwoo->scope["user"] : null));?>

	</div>
	<div class="grid_14 omega">
		<h2><?php echo $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'first_name',  ),  3 =>   array (    0 => '',    1 => '',  ),), $dwoo->scope["user"], false);?> "<span><?php echo Dwoo_Plugin_userlink_4ad9e654de1be($dwoo, (isset($dwoo->scope["user"]) ? $dwoo->scope["user"] : null));?></span>" <?php echo $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'last_name',  ),  3 =>   array (    0 => '',    1 => '',  ),), $dwoo->scope["user"], false);?></h2>
...
?>, <span class="online">Online</span><?php 
		...
		<?php echo Dwoo_Plugin_actions_4ad9e654e33a6($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'actions',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["user"]) ? $dwoo->scope["user"]:null), true), 0);?>
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4ad9e6550a2dd($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4ad9e6550a2dd($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4ad9e6550a2dd($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad9e6550a2dd($this, "password", "password", "Lösen: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad9e6550a2dd($this, "submit", "login", "", "Ja!", '');?>
...
<div id="content-wrap">
	<?php echo Dwoo_Plugin_messages_4ad9e6553bfd6($this, Dwoo_Plugin_getMessages($this));?>

<div id="content" class="container_16">
	<div class="grid_16">
<?php echo Dwoo_Plugin_userbar_4ad9e6553c7f0($this, (isset($this->scope["user"]) ? $this->scope["user"] : null));?>
...
/* -- foreach start output */
?>
	<?php echo Dwoo_Plugin_teaser_4ad9e654ec023($this, (isset($this->scope["thought"]) ? $this->scope["thought"] : null), true);?>
