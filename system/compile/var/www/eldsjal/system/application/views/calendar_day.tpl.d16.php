...
if (!function_exists('Dwoo_Plugin_userlink_4a89484be6565')) {
function Dwoo_Plugin_userlink_4a89484be6565(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4a89484be6565'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a89484be6565'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_actions_4a89484bea77f')) {
function Dwoo_Plugin_actions_4a89484bea77f(Dwoo $dwoo, $actions) {
static $_callCnt = 0;
$dwoo->scope[' 4a89484bea77f'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a89484bea77f'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_input_4a89484c0c8f4')) {
function Dwoo_Plugin_input_4a89484c0c8f4(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4a89484c0c8f4'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a89484c0c8f4'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_datepager_4a89484c1cf33')) {
function Dwoo_Plugin_datepager_4a89484c1cf33(Dwoo $dwoo, $prefix, $year, $month = null, $day = null) {
static $_callCnt = 0;
$dwoo->scope[' 4a89484c1cf33'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a89484c1cf33'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_event_teaser_4a89484c2c146')) {
function Dwoo_Plugin_event_teaser_4a89484c2c146(Dwoo $dwoo, $data, $truncate = true) {
static $_callCnt = 0;
$dwoo->scope[' 4a89484c2c146'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a89484c2c146'.($_callCnt++)));
...
?> <?php echo Dwoo_Plugin_fuzzytime($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'date',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), true, 'Y-m-d H:i');
		...
		<h4 class="subtitle"><span class="event-date"><?php echo Dwoo_Plugin_nicedate($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'date',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true));?> i <?php echo $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'locationName',  ),  3 =>   array (    0 => '',    1 => '',  ),), $dwoo->scope["data"], false);?></span> | Upplagd av <?php echo Dwoo_Plugin_userlink_4a89484be6565($dwoo, (isset($dwoo->scope["data"]) ? $dwoo->scope["data"] : null));?> <?php echo Dwoo_Plugin_fuzzytime($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'created',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), true, 'Y-m-d H:i');?></h4>
...
?>
		...
		<?php echo Dwoo_Plugin_actions_4a89484bea77f($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'actions',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true));?>
...
if (!function_exists('Dwoo_Plugin_messages_4a89484c2ec28')) {
function Dwoo_Plugin_messages_4a89484c2ec28(Dwoo $dwoo, $messages) {
static $_callCnt = 0;
$dwoo->scope[' 4a89484c2ec28'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a89484c2ec28'.($_callCnt++)));
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4a89484c0c8f4($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4a89484c0c8f4($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4a89484c0c8f4($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4a89484c0c8f4($this, "password", "password", "Lösen: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4a89484c0c8f4($this, "submit", "login", "", "Ja!", '');?>
...
<div id="content-wrap">
	<?php echo Dwoo_Plugin_messages_4a89484c2ec28($this, Dwoo_Plugin_getMessages($this));?>

<div id="content" class="container_16">
	<div class="grid_16">
<?php echo Dwoo_Plugin_datepager_4a89484c1cf33($this, '/calendar/browse/', (isset($this->scope["year"]) ? $this->scope["year"] : null), (isset($this->scope["month"]) ? $this->scope["month"] : null), (isset($this->scope["day"]) ? $this->scope["day"] : null));?>

<?php 
$_fh6_data = (isset($this->scope["events"]) ? $this->scope["events"] : null);
...
/* -- foreach start output */
?>
	<?php echo Dwoo_Plugin_event_teaser_4a89484c2c146($this, (isset($this->scope["event"]) ? $this->scope["event"] : null), true);?>
