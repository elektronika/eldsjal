...
if (!function_exists('Dwoo_Plugin_userlink_4ada0ce17beac')) {
function Dwoo_Plugin_userlink_4ada0ce17beac(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4ada0ce17beac'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ada0ce17beac'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_userimage_4ada0ce17e58d')) {
function Dwoo_Plugin_userimage_4ada0ce17e58d(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4ada0ce17e58d'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ada0ce17e58d'.($_callCnt++)));
$dwoo->scope['user'] = $user;
...
if (!function_exists('Dwoo_Plugin_actions_4ada0ce180c99')) {
function Dwoo_Plugin_actions_4ada0ce180c99(Dwoo $dwoo, $actions, $iconsonly = 1) {
static $_callCnt = 0;
$dwoo->scope[' 4ada0ce180c99'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ada0ce180c99'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_bubble_4ada0ce183f61')) {
function Dwoo_Plugin_bubble_4ada0ce183f61(Dwoo $dwoo, $data) {
static $_callCnt = 0;
$dwoo->scope[' 4ada0ce183f61'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ada0ce183f61'.($_callCnt++)));
...
?><a name="post-<?php echo $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'id',  ),  3 =>   array (    0 => '',    1 => '',  ),), $dwoo->scope["data"], false);?>"></a><?php 
	...
	<div class="bubble-userdata">
		<?php echo Dwoo_Plugin_userimage_4ada0ce17e58d($dwoo, (isset($dwoo->scope["data"]) ? $dwoo->scope["data"] : null));?>

		<?php echo Dwoo_Plugin_userlink_4ada0ce17beac($dwoo, (isset($dwoo->scope["data"]) ? $dwoo->scope["data"] : null));?>
	...
	<?php echo Dwoo_Plugin_fuzzytime($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'created',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), null, null, 'Y-m-d H:i');?> <?php echo Dwoo_Plugin_actions_4ada0ce180c99($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'actions',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), 1);?>
...
if (!function_exists('Dwoo_Plugin_input_4ada0ce199f24')) {
function Dwoo_Plugin_input_4ada0ce199f24(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4ada0ce199f24'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ada0ce199f24'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_messages_4ada0ce1c2763')) {
function Dwoo_Plugin_messages_4ada0ce1c2763(Dwoo $dwoo, $messages) {
static $_callCnt = 0;
$dwoo->scope[' 4ada0ce1c2763'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ada0ce1c2763'.($_callCnt++)));
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4ada0ce199f24($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4ada0ce199f24($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4ada0ce199f24($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ada0ce199f24($this, "password", "password", "Lösen: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ada0ce199f24($this, "submit", "login", "", "Ja!", '');?>
...
<div id="content-wrap">
	<?php echo Dwoo_Plugin_messages_4ada0ce1c2763($this, Dwoo_Plugin_getMessages($this));?>

<div id="content" class="container_16">
	<div class="grid_16">
<h2 class="title"><?php echo $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'title',  ),  3 =>   array (    0 => '',    1 => '',  ),), $this->scope["thought"], false);?> <span><?php echo Dwoo_Plugin_fuzzytime($this, $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'created',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["thought"]) ? $this->scope["thought"]:null), true), null, null, 'Y-m-d H:i');?></span></h2>
<?php echo Dwoo_Plugin_bubble_4ada0ce183f61($this, (isset($this->scope["thought"]) ? $this->scope["thought"] : null));?>
