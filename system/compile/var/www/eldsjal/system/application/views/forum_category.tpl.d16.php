...
if (function_exists('Dwoo_Plugin_shortdate')===false)
	$this->getLoader()->loadPlugin('shortdate');
...
if (!function_exists('Dwoo_Plugin_userlink_4ad9e05a05ee5')) {
function Dwoo_Plugin_userlink_4ad9e05a05ee5(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e05a05ee5'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e05a05ee5'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_pager_4ad9e05a0a166')) {
function Dwoo_Plugin_pager_4ad9e05a0a166(Dwoo $dwoo, $pager) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e05a0a166'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e05a0a166'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_actions_4ad9e05a0b4a1')) {
function Dwoo_Plugin_actions_4ad9e05a0b4a1(Dwoo $dwoo, $actions, $iconsonly = 1) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e05a0b4a1'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e05a0b4a1'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_input_4ad9e05a281d5')) {
function Dwoo_Plugin_input_4ad9e05a281d5(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e05a281d5'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e05a281d5'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_messages_4ad9e05a55c08')) {
function Dwoo_Plugin_messages_4ad9e05a55c08(Dwoo $dwoo, $messages) {
static $_callCnt = 0;
$dwoo->scope[' 4ad9e05a55c08'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ad9e05a55c08'.($_callCnt++)));
...
'';// checking for modification in file:/var/www/eldsjal/system/application/views/forum.tpl
if (!("1250276013" == filemtime('/var/www/eldsjal/system/application/views/forum.tpl'))) { ob_end_clean(); return false; };
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4ad9e05a281d5($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4ad9e05a281d5($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4ad9e05a281d5($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad9e05a281d5($this, "password", "password", "Lösen: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ad9e05a281d5($this, "submit", "login", "", "Ja!", '');?>
...
<div id="content-wrap">
	<?php echo Dwoo_Plugin_messages_4ad9e05a55c08($this, Dwoo_Plugin_getMessages($this));?>

<div id="content" class="container_16">
	<div class="grid_16">
<h2><?php echo '<a href="'."/forum".'">';?>Forum</a> &raquo; <?php echo $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'forumCategoryName',  ),  3 =>   array (    0 => '',    1 => '',  ),), $this->scope["category"], false);?></h2>
<table id="forum-topics">
	...
	<tbody>
<?php 
$_fh6_data = (isset($this->scope["topics"]) ? $this->scope["topics"] : null);
if ($this->isArray($_fh6_data) === true)
{
	foreach ($_fh6_data as $this->scope['topic'])
	{
/* -- foreach start output */
?>
		<tr class="<?php echo implode(' ', $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'classes',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["topic"]) ? $this->scope["topic"]:null), true));?>">
			<td class="topic-subject"><?php echo '<a href="'."/forum/topic/".$this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'id',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["topic"]) ? $this->scope["topic"]:null), true)."".'" class="'."topic-link".'">';
echo $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'title',  ),  3 =>   array (    0 => '',    1 => '',  ),), $this->scope["topic"], false);?></a><?php echo Dwoo_Plugin_actions_4ad9e05a0b4a1($this, $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'actions',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["topic"]) ? $this->scope["topic"]:null), true), 1);?></td>
			<td class="topic-lastrepy"><?php if ($this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'replies',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["topic"]) ? $this->scope["topic"]:null), true) == 0) {
?>-<?php 
}
else {

echo Dwoo_Plugin_fuzzytime($this, $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'updated',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["topic"]) ? $this->scope["topic"]:null), true), '', ' sedan', 'Y-m-d H:i');?> av <?php echo Dwoo_Plugin_userlink_4ad9e05a05ee5($this, $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'updater',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["topic"]) ? $this->scope["topic"]:null), true));

}?></td>
			<td class="topic-replies"><?php echo $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'replies',  ),  3 =>   array (    0 => '',    1 => '',  ),), $this->scope["topic"], false);?></td>
			<td class="topic-creator"><?php echo Dwoo_Plugin_shortdate($this, $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'created',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["topic"]) ? $this->scope["topic"]:null), true));?> av <?php echo Dwoo_Plugin_userlink_4ad9e05a05ee5($this, $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'creator',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($this->scope["topic"]) ? $this->scope["topic"]:null), true));?></td>
		</tr>
<?php 
/* -- foreach end output */
	}
...
<?php echo Dwoo_Plugin_pager_4ad9e05a0a166($this, (isset($this->scope["pager"]) ? $this->scope["pager"] : null));?>
