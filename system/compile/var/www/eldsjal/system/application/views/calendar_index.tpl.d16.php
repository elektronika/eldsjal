...
if (!function_exists('Dwoo_Plugin_userlink_4ada0985978ea')) {
function Dwoo_Plugin_userlink_4ada0985978ea(Dwoo $dwoo, $user) {
static $_callCnt = 0;
$dwoo->scope[' 4ada0985978ea'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ada0985978ea'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_actions_4ada09859ea08')) {
function Dwoo_Plugin_actions_4ada09859ea08(Dwoo $dwoo, $actions, $iconsonly = 1) {
static $_callCnt = 0;
$dwoo->scope[' 4ada09859ea08'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ada09859ea08'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_input_4ada0985c305e')) {
function Dwoo_Plugin_input_4ada0985c305e(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4ada0985c305e'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ada0985c305e'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_event_teaser_4ada0985ea8ff')) {
function Dwoo_Plugin_event_teaser_4ada0985ea8ff(Dwoo $dwoo, $data, $truncate = true) {
static $_callCnt = 0;
$dwoo->scope[' 4ada0985ea8ff'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ada0985ea8ff'.($_callCnt++)));
...
?> <?php echo Dwoo_Plugin_fuzzytime($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'date',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), null, null, 'Y-m-d H:i');

}?>

			</span>
	</h3>
		<h4 class="subtitle"><span class="event-date"><?php echo Dwoo_Plugin_nicedate($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'date',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true));?> i <?php echo $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'locationName',  ),  3 =>   array (    0 => '',    1 => '',  ),), $dwoo->scope["data"], false);?></span> | Upplagd av <?php echo Dwoo_Plugin_userlink_4ada0985978ea($dwoo, (isset($dwoo->scope["data"]) ? $dwoo->scope["data"] : null));?> <?php echo Dwoo_Plugin_fuzzytime($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'created',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), null, null, 'Y-m-d H:i');?></h4>
...
?>
		...
		<?php echo Dwoo_Plugin_actions_4ada09859ea08($dwoo, $dwoo->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'actions',  ),  3 =>   array (    0 => '',    1 => '',  ),), (isset($dwoo->scope["data"]) ? $dwoo->scope["data"]:null), true), 1);?>
...
if (!function_exists('Dwoo_Plugin_messages_4ada0985ee785')) {
function Dwoo_Plugin_messages_4ada0985ee785(Dwoo $dwoo, $messages) {
static $_callCnt = 0;
$dwoo->scope[' 4ada0985ee785'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4ada0985ee785'.($_callCnt++)));
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4ada0985c305e($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4ada0985c305e($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4ada0985c305e($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ada0985c305e($this, "password", "password", "Lösen: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4ada0985c305e($this, "submit", "login", "", "Ja!", '');?>
...
<div id="content-wrap">
	<?php echo Dwoo_Plugin_messages_4ada0985ee785($this, Dwoo_Plugin_getMessages($this));?>

<div id="content" class="container_12">
	<div class="grid_16">
<div class="grid_8 alpha">
	<?php 
$_fh6_data = (isset($this->scope["upcoming"]) ? $this->scope["upcoming"] : null);
if ($this->isArray($_fh6_data) === true)
{
	foreach ($_fh6_data as $this->scope['event'])
	{
/* -- foreach start output */
?>
		<?php echo Dwoo_Plugin_event_teaser_4ada0985ea8ff($this, (isset($this->scope["event"]) ? $this->scope["event"] : null), true);?>
...
<div class="grid_4 omega">
	...
	<p>
	<a href="/calendar/browse/<?php echo date('Y');?>">...detta året</a><br/>
	<a href="/calendar/browse/<?php echo date('Y/m');?>">...denna månaden</a><br/>
	<a href="/calendar/browse/<?php echo date('Y/m/d');?>">...idag</a></p>
	<?php if ((isset($this->scope["attending"]) ? $this->scope["attending"] : null)) {
?>
	<h3>Du är anmäld till...</h3>
	<ul class="attending event-list">
	<?php 
$_fh7_data = (isset($this->scope["attending"]) ? $this->scope["attending"] : null);
if ($this->isArray($_fh7_data) === true)
{
	foreach ($_fh7_data as $this->scope['event'])
	{
/* -- foreach start output */
?>
		<li><a href="/calendar/view/<?php echo $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'id',  ),  3 =>   array (    0 => '',    1 => '',  ),), $this->scope["event"], false);?>"><?php echo $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'title',  ),  3 =>   array (    0 => '',    1 => '',  ),), $this->scope["event"], false);?></a></li>
	<?php 
/* -- foreach end output */
	}
}
	...
	<?php if ((isset($this->scope["posted"]) ? $this->scope["posted"] : null)) {
?>
	<h3>Du lagt upp...</h3>
	<ul class="posted event-list">
	<?php 
$_fh8_data = (isset($this->scope["posted"]) ? $this->scope["posted"] : null);
if ($this->isArray($_fh8_data) === true)
{
	foreach ($_fh8_data as $this->scope['event'])
	{
/* -- foreach start output */
?>
		<li><a href="/calendar/view/<?php echo $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'id',  ),  3 =>   array (    0 => '',    1 => '',  ),), $this->scope["event"], false);?>"><?php echo $this->readVarInto(array (  1 =>   array (    0 => '->',  ),  2 =>   array (    0 => 'title',  ),  3 =>   array (    0 => '',    1 => '',  ),), $this->scope["event"], false);?></a></li>
