...
if (!function_exists('Dwoo_Plugin_input_4a8bec6826913')) {
function Dwoo_Plugin_input_4a8bec6826913(Dwoo $dwoo, $type, $name, $label = "", $value = "", $error = "") {
static $_callCnt = 0;
$dwoo->scope[' 4a8bec6826913'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a8bec6826913'.($_callCnt++)));
...
if (!function_exists('Dwoo_Plugin_messages_4a8bec684bedb')) {
function Dwoo_Plugin_messages_4a8bec684bedb(Dwoo $dwoo, $messages) {
static $_callCnt = 0;
$dwoo->scope[' 4a8bec684bedb'.$_callCnt] = array();
$_scope = $dwoo->setScope(array(' 4a8bec684bedb'.($_callCnt++)));
...
?>
			...
			<form id="quicksearch" action = "/members.php?mode=listMembers" method = "post"> 
				<div>
				<?php echo Dwoo_Plugin_input_4a8bec6826913($this, "text", "username", '', '', '');?> 
				<?php echo Dwoo_Plugin_input_4a8bec6826913($this, "submit", "search", "", "Sök", '');?>
...
?>
				<form id="login" method="post" action="/login">
					<div>
						<?php echo Dwoo_Plugin_input_4a8bec6826913($this, "text", "username", "Namn: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4a8bec6826913($this, "password", "password", "Lösen: ", '', '');?>

						<?php echo Dwoo_Plugin_input_4a8bec6826913($this, "submit", "login", "", "Ja!", '');?>
...
<div id="content-wrap">
	<?php echo Dwoo_Plugin_messages_4a8bec684bedb($this, Dwoo_Plugin_getMessages($this));?>

<div id="content" class="container_16">
	<div class="grid_16">
<p>Yay, bilden är uppladdad!</p>
<p><?php echo $this->scope["resize_error"];?></p>
	</div>
</div>
<div class="clear"> </div>
</div>
