...
class Main extends MY_Controller {
	function get_index() {
		if($this->session->isLoggedIn()) {
			...
			$this->view->widgets = array('left' => explode(',', $this->settings->get('widgets_left_front')));
		} else {
			$this->view->widgets = array('left' => explode(',', $this->settings->get('widgets_left_front_guest')));
		}
