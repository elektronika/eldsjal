...
foreach( $loginHistories as $loginHistory ) {
	...
	print "<a class=\"a2\" onMouseOver=\"return overlib('<div class=miniPicture><img src=".$image." height=45></div><div class=miniPictureText>".rqJS( $loginHistory['username'] )."<br>Medlem sedan: ".$memberSince."</div>',WIDTH=100);\" onMouseOut=\"return nd();\" href=\"userPresentation.php?userid=".$loginHistory['userid']."\">".$loginHistory['username']."</a> - ".$loginTime."<br>";
