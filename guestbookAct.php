...
elseif( $_GET['mode'] == "delete" ) {
	...
	//Logger
	$sql = "insert into history (action, userid, nick, message, [date], security) values ('guestbookdelete',".$_SESSION['userid'].", '".$_SESSION['username']."', '".$_SESSION['username']." tar bort ett g&auml;stboksinl&auml;gg', getdate(), 0)";
	$conn->execute( $sql );
