...
.form_upload('image')
.form_fieldset_close()
.form_fieldset('För säkerhets skull...')
.form_label(form_checkbox('pul', 1).'Ja, jag tillåter att mina personuppgifter lagras i enlighet med PUL. (personuppgiftslagen)')
.form_error('pul', "<span class='form-error-description'>", "</span>")
.form_label(form_checkbox('rules', 1).'Ja, jag kommer att vara snel hest och inte bete mig som ett blockmongo.')
.form_error('rules', "<span class='form-error-description'>", "</span>")
.form_label(form_checkbox('cookies', 1).'Ja, jag är ok med att ta emot cookies från eldsjal.org. Speciellt om dom är goda.')
.form_error('cookies', "<span class='form-error-description'>", "</span>")
.form_fieldset_close()
.submit('Spara!')
.form_close();
?>
