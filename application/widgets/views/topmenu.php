<div id="navbar">
	<div class="inner">
	<div id="menuItems">
		<a <?php if($active == 'forum') echo 'class="active" ' ?>href="/forum" title="Diskutera, fundera och spekulera fritt med andra eldsjälar *inlägg kräver medlemskap*">Forum<span class="tagline">Snacka loss!</span></a>
		<a <?php if($active == 'calendar') echo 'class="active" ' ?>href="/calendar" title="Se vad som händer runtomkring i världen!">Kalender<span class="tagline">Se vad som händer</span></a>
