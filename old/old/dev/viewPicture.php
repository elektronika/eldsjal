...
<?php
	$sql = "select users.username, users.userid, images.imagename, images.imagedesc, images.imageid, images.imageuploaddate, images.uploadedby, images.filetype, images.clicks from images inner join users on images.uploadedby = users.userid inner join imageartlist on images.imageid = imageartlist.imageid where images.imageid = ".intval( $_GET['imageid'] );
