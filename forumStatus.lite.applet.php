...
if( $application['systemforumcount'] > 0 ) {
	...
	foreach( $messagess as $messages ) {
		...
		$message = rq($message);
		print "<tr><td colspan=\"2\">&raquo;&nbsp;<a href=\"/forum/topic/".$messages['topicid']."\" class=\"a2\">".$messages['topicname']."</td></tr><tr><td CLASS='plaintext'><B>&nbsp;</B></td><td CLASS='plaintext'>".$message."</td></tr><tr><td>&nbsp;</td><td>&nbsp;</td></tr>";
	}
