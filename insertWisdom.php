...
foreach( $wisdoms as $wisdom ) {
	...
	$i = $i + 1;
	print "<tr><td valign=top>".$i.":&nbsp;</td><td><a href=insertWisdom.php?id=".$wisdom['wiseboxid']." class=a3>".$cWisdom."</a></td><td><a href=insertWisdom.php?mode=delete&id=".$wisdom['wiseboxid']."><img src=images/icons/trashcan.gif border=0 alt=\"Delete wisdom\"></a></td></tr>";
